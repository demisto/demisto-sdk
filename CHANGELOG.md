...
### Fix
* Fixed an issue when creating a release note for an ApiModule also created release notes for deprecated integrations. [#4948](https://github.com/demisto/demisto-sdk/pull/4948)
* Fix XSIAM tags utilization for platform packs' README files. [#4949](https://github.com/demisto/demisto-sdk/pull/4949)
* Added support to upload Wizards only to the XSOAR marketplace. [#4946](https://github.com/demisto/demisto-sdk/pull/4946)
* Fixed an issue where logging would fail when the --show-diff-on-failure flag of the pre-commit command was selected. [#4941](https://github.com/demisto/demisto-sdk/pull/4941)
...
### Internal
* Fixed IM109 validation's message. [#4936](https://github.com/demisto/demisto-sdk/pull/4936)
