...
* Fixed an issue where **<command>** would <bad thing> when <condition>
* Added support to control the maximum file size and log rotation files count in the sdk logger.
* Fixed an issue with where passing the deprecated logging arguments to any command presented the wrong recommendation for the argument substitution.
* Fixed an issue with where **graph** commands logging argument documentation was wrong.
* Fixed an issue with where **generate-unit-tests** logging argument documentation was wrong.
* Fixed an issue with where **generate-modeling-rules** logging argument documentation was wrong.
