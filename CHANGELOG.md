...
* Moved the CR101 validation to the new validation format. Checks names if "Correlation Rule" files match standards to `validate_content_path`. [#4569](https://github.com/demisto/demisto-sdk/pull/4569)
