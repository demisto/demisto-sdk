...
* Breaking changes: **ValidateManager** was renamed to **OldValidateManager** and can now be found at the following [path],(demisto_sdk/commands/validate/old_validate_manager.py)
