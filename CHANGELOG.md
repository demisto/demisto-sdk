...
* Updated the code to use the GCS_MARKET_BUCKET, GCS_MARKET_BUCKET_DEV, GCS_MARKET_XPANSE_BUCKET, GCS_MARKET_V2_BUCKET, GCS_MARKET_XSOAR_SAAS_BUCKET, DOCKER_IO, CI_PROJECT_ID, CI_PROJECT_ID environment variables.
