...
* Added default env vars **DEMISTO_DEFAULT_REMOTE** and **DEMISTO_DEFAULT_REMOTE** with default values **origin**  and **master**, set these vars if your remote or main branch named differently.
