# Changelog
## Unreleased
* Log files are no longer generated by default. A log file will only be generated if the `--log-file-path` flag or the `DEMISTO_SDK_LOG_FILE_PATH` environment variable are set to a specific path.
