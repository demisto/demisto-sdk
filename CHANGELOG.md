...
## 1.38.22 (2026-03-15)
### Feature
* Added a new validation (GR113) which validates managed playbooks does not use scripts or sub-playbooks that are not managed or from our core packs. #5241](https://github.com/demisto/demisto-sdk/pull/5241)
