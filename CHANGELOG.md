# Changelog
## 1.31.3
* Removed IN150 - invalid_siem_integration_name from both old and new validate flows. [#4420](https://github.com/demisto/demisto-sdk/pull/4420)
* Removed RM108 & RM112 from the old validate. [#4408](https://github.com/demisto/demisto-sdk/pull/4408)
...
* Refactored validation GR100, that checks whether a content item attempts to use other content items which are not supported in all of the marketplaces of the content item. [#4282](https://github.com/demisto/demisto-sdk/pull/4282)
* Added the ability to use git.Repo object to initialize GitUtil. [#4387](https://github.com/demisto/demisto-sdk/pull/4387)
* Print timestamp in console in every environment. [#4412](https://github.com/demisto/demisto-sdk/pull/4412)
...
* Fixed an issue where the Relative path regex wasn't written correctly. This fix affect RM108, RM114 validation in the new validate. [#4413](https://github.com/demisto/demisto-sdk/pull/4413)
...
* Added support to the (internal) **test-content** command to work properly with multiple cloud servers. [#4321](https://github.com/demisto/demisto-sdk/pull/4321)
