...
* Improved the documentation for the **pre-commit** command. [#4421](https://github.com/demisto/demisto-sdk/pull/4421)
...
* Improved the implementation of the **pre-commit** hook ***validate-file-permission-changes***. [#4434](https://github.com/demisto/demisto-sdk/pull/4434)
...
* Remove the **validate-file-permissions-changes** pre-commit hook. [#4436](https://github.com/demisto/demisto-sdk/pull/4436)
