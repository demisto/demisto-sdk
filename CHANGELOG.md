...
* Added support to send custom arguments when dumping json/yml files to the file model.
* Updated that when writing json/yml files, an automatic default indent will be taken.
