# Changelog
## 1.30.0
* Started adaption for **demisto-sdk lint** command. The command will be fully removed soon Use **demisto-sdk pre-commit** instead. [#4286](https://github.com/demisto/demisto-sdk/pull/4286)
...
* ֹ"Converted the RM106 validation to the new format. The validation verifies that README doesn't contain the word 'demisto'". [#4295](https://github.com/demisto/demisto-sdk/pull/4295)
...
* ֹConverted the DS107 validation to the new format. The validation verifies the integration description doesn't contain the word 'demisto'. [#4296](https://github.com/demisto/demisto-sdk/pull/4296)
