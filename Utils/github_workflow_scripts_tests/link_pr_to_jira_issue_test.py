...
PR_TEST_CASE = [
    ...
    (
        PR_WITH_MULTIPLE_FIXES_BY_NEWLINE,
        False,
        ["CIAC-3473", "CIAC-3475"],
        ["fixes", "fixes"],
    ),
...
@pytest.mark.parametrize(
    "pr_body, is_merged, expected_ids, expected_actions", PR_TEST_CASE
)
...
def test_trigger_generic_webhook(requests_mock, is_merged, expected):
    ...
    option_mock = OptionMock(
        "pr_link_example", "1", "dummy pr", PR_WITH_BOTH_BY_NEWLINE, is_merged
    )
