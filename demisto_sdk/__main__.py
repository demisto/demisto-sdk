...
def create_id_set(**kwargs):
    ...
    # f = open("/Users/rshalem/dev/demisto/demisto-sdk/demisto_sdk/test_id_set.json")
    # id_set = json.load(f)
    # excluded_items_by_pack = {'Expanse': {('integration', 'Expanse'), ('incidenttype', 'Expanse Behavior'), ('playbook', 'Expanse Behavior Severity Update'), ('incidenttype', 'Expanse Appearance'), ('classifier', '95573d05-345e-43b6-82f1-a5a8ad402e69'), ('playbook', 'ExpanseParseRawIncident'), ('script', 'ExpanseParseRawIncident')}, 'ExpanseV2': {('incidenttype', 'Expanse Issue'), ('playbook', 'Expanse Unmanaged Cloud'), ('script', 'MatchIPinCIDRIndicators'), ('indicatorfield', 'indicator_expanseservicestatus'), ('script', 'ExpanseRefreshIssueAssets'), ('indicatorfield', 'indicator_expansebusinessunits'), ('playbook', 'Handle Expanse Incident - Attribution Only'), ('script', 'ExpanseGenerateIssueMapWidgetScript'), ('playbook', 'Expanse Load-Create List'), ('indicatorfield', 'indicator_expansednsresolutionstatus'), ('indicatorfield', 'indicator_expansecertificateadvertisementstatus'), ('mapper', 'ExpanseV2-mapper'), ('script', 'ExpanseEnrichAttribution'), ('playbook', 'Expanse Find Cloud IP Address Region and Service'), ('indicatorfield', 'indicator_expanselastobserved'), ('integration', 'FeedExpanse'), ('indicatorfield', 'indicator_expansetype'), ('script', 'ExpanseAggregateAttributionCI'), ('playbook', 'Expanse VM Enrich'), ('indicatorfield', 'indicator_expansetenantname'), ('integration', 'ExpanseV2'), ('playbook', 'Handle Expanse Incident'), ('indicatorfield', 'indicator_expanseproperties'), ('indicatorfield', 'indicator_expansefirstobserved'), ('playbook', 'Expanse Attribution'), ('playbook', 'Xpanse Incident Handling - Generic'), ('script', 'ExpanseAggregateAttributionIP'), ('playbook', 'NSA - 5 Security Vulnerabilities Under Active Nation-State Attack'), ('indicatorfield', 'indicator_expanseprovidername'), ('playbook', 'Expanse Enrich Cloud Assets'), ('indicatorfield', 'indicator_expansedateadded'), ('script', 'ExpansePrintSuggestions'), ('playbook', 'Extract and Enrich Expanse Indicators'), ('indicatorfield', 'indicator_expansetags'), ('script', 'ExpanseEvidenceDynamicSection'), ('classifier', 'ExpanseV2'), ('indicatorfield', 'indicator_expansesourcedomain'), ('incidenttype', 'Xpanse Issue - Generic'), ('script', 'ExpanseAggregateAttributionDevice'), ('indicatorfield', 'indicator_expansedomain'), ('script', 'ExpanseAggregateAttributionUser'), ('indicatorfield', 'indicator_expanseassettype')}, 'Traps': {('playbook', 'Traps Scan Endpoint'), ('playbook', 'Traps Blacklist File'), ('playbook', 'Traps Isolate Endpoint'), ('playbook', 'Traps Retrieve And Download Files'), ('integration', 'Palo Alto Traps ESM (Beta)'), ('integration', 'Traps'), ('playbook', 'Traps Quarantine Event'), ('incidenttype', 'Traps')}, 'CortexXDR': {('playbook', 'Cortex XDR - Unisolate Endpoint'), ('incidenttype', 'Cortex XDR Device Control Violations'), ('playbook', 'Cortex XDR - Execute commands'), ('mapper', 'Cortex XDR - IR-out-mapper'), ('playbook', 'Cortex XDR - quarantine file'), ('incidenttype', 'Cortex XDR Port Scan'), ('playbook', 'Cortex XDR - Retrieve File Playbook'), ('playbook', 'Cortex XDR - Check Action Status'), ('playbook', 'Cortex XDR - Malware Investigation'), ('script', 'DBotGroupXDRIncidents'), ('playbook', 'Cortex XDR - PrintNightmare Detection and Response'), ('playbook', 'Cortex XDR - Block File'), ('integration', 'Cortex XDR - IOC'), ('playbook', 'Cortex XDR - check file existence'), ('playbook', 'Cortex XDR - Port Scan'), ('incidenttype', 'Cortex XDR Incident'), ('classifier', 'Cortex XDR - IR'), ('classifier', '32f26072-9a69-41a5-8db8-0d1226431078'), ('mapper', 'Cortex XDR - IR-mapper'), ('playbook', 'Cortex XDR - Run script'), ('playbook', 'Cortex XDR Incident Sync'), ('playbook', 'Cortex XDR - Isolate Endpoint'), ('script', 'XDRConnectedEndpoints'), ('script', 'CortexXDRAdditionalAlertInformationWidget'), ('playbook', 'Cortex XDR Incident Handling'), ('playbook', 'Cortex XDR device control violations'), ('script', 'CortexXDRCloudProviderWidget'), ('playbook', 'Cortex XDR - kill process'), ('script', 'EntryWidgetPieAlertsXDR'), ('script', 'CortexXDRIdentityInformationWidget'), ('script', 'EntryWidgetNumberHostsXDR'), ('playbook', 'Cortex XDR - AWS IAM user access investigation'), ('script', 'XDRDisconnectedEndpoints'), ('script', 'EntryWidgetNumberUsersXDR'), ('playbook', 'JOB - Cortex XDR query endpoint device control violations'), ('integration', 'Cortex XDR - XQL Query Engine'), ('playbook', 'Cortex XDR Alerts Handling'), ('script', 'XDRSyncScript'), ('script', 'CortexXDRRemediationActionsWidget'), ('incidenttype', 'Cortex XDR Disconnected endpoints'), ('playbook', 'Cortex XDR incident handling v3'), ('incidenttype', 'Cortex XDR - XCLOUD'), ('playbook', 'Cortex XDR - Execute snippet code script'), ('playbook', 'Cortex XDR - Port Scan - Adjusted'), ('playbook', 'Cortex XDR - delete file'), ('integration', 'Cortex XDR - IR'), ('playbook', 'Cortex XDR disconnected endpoints'), ('indicatorfield', 'indicator_xdrstatus'), ('playbook', 'Cortex XDR incident handling v2')}, 'DeprecatedContent': {('script', 'PanoramaCommit'), ('playbook', 'Get Mails By Folder Pathes'), ('playbook', 'ExtraHop - Ticket Tracking'), ('script', 'ExtractEmail'), ('playbook', 'block_ip_-_generic'), ('script', 'JiraGetIssue'), ('script', 'SetIncidentCustomFields'), ('script', 'ExposeUsers'), ('script', 'CheckURLs'), ('script', 'getMlFeatures'), ('playbook', 'extract_indicators_-_generic'), ('playbook', 'DBotCreatePhishingClassifierJob'), ('script', 'GetContextValue'), ('script', 'AwsGetInstanceInfo'), ('script', 'ExchangeSearchMailbox'), ('script', 'PWObservations'), ('script', 'AwsStopInstance'), ('script', 'LCMIndicatorsForEntity'), ('script', 'QrFullSearch'), ('script', 'ADGetGroupMembers'), ('script', 'LCMPathFinderScanHost'), ('script', '7b5c080e-f3b1-411a-83b0-e1f53c21bef8'), ('script', 'ReadPDFFile'), ('integration', 'Lockpath KeyLight'), ('script', 'CheckFiles'), ('script', 'CheckWhitelist'), ('script', 'PWObservationDetails'), ('script', 'CheckIPs'), ('integration', 'Secdo'), ('playbook', 'Enrich DXL with ATD verdict'), ('script', 'AwsRunInstance'), ('script', 'XBTimeline'), ('script', 'CommonIntegration'), ('playbook', 'malware_investigation-_generic'), ('playbook', 'entity_enrichment_generic'), ('script', 'QrGetSearchResults'), ('script', 'GoogleappsListUsers'), ('script', 'ExtractIP'), ('script', 'LCMAcknowledgeHost'), ('playbook', 'vulnerability_handling_-_qualys_-_add _ustom_fields_to_default_layout'), ('playbook', 'playbook12'), ('playbook', 'playbook1'), ('script', 'ExtractDomain'), ('script', 'SplunkSearchJsonPy'), ('script', 'DemistoDeleteIncident'), ('script', 'ParseEmailHeader'), ('script', 'VectraGetHostById'), ('script', 'VectraSensors'), ('script', 'IsContextSet'), ('script', 'XBLockouts'), ('script', 'NessusListScans'), ('integration', 'Phishme Intelligence'), ('script', 'DataHashReputation'), ('script', 'CloseInvestigation'), ('script', 'Elasticsearch'), ('script', 'CPSetRule'), ('script', 'DBotPredictTextLabel'), ('script', 'DBotPredictPhishingLabel'), ('playbook', 'Failed Login Playbook - Slack v2'), ('playbook', 'Palo Alto Networks - Endpoint Malware Investigation v2'), ('script', 'IsIPInSubnet'), ('script', '9364c36f-b1d6-4233-88c2-75008b106c31'), ('script', 'PWEventDetails'), ('script', 'PWSensors'), ('script', 'VectraDetections'), ('playbook', 'DBotCreatePhishingClassifier'), ('script', 'ExchangeAssignRole'), ('script', 'LCMSetHostComment'), ('script', 'GoogleappsGmailSearch'), ('script', 'ADListUsersEx'), ('script', 'ConferSetSeverity'), ('script', 'GoogleappsGetUser'), ('playbook', 'process_email_-_add_custom_fields'), ('playbook', 'PAN-OS - Block IP and URL - External Dynamic List'), ('script', 'DBotPredictPhishingEvaluation'), ('script', 'VectraSettings'), ('script', 'CPShowAccessRulebase'), ('script', 'GoogleappsRevokeUserRole'), ('playbook', 'Incident Enrichment'), ('script', 'DBotPreparePhishingData'), ('script', 'XBInfo'), ('playbook', 'Process Email'), ('script', 'NessusShowEditorTemplates'), ('script', 'URLExtract'), ('playbook', 'add_indicator_to_miner_-_palo_alto_mineMeld'), ('script', 'ExchangeSearch'), ('playbook', 'Enrich McAfee DXL using 3rd party sandbox'), ('script', 'AwsStartInstance'), ('script', 'LCMResolveHost'), ('script', 'CSIndicators'), ('script', 'ADGetEmailForAllUsers'), ('playbook', 'playbook14'), ('script', 'dbbdc2e4-6105-4ee9-8e83-563a4b991a89'), ('integration', 'Azure Security Center'), ('script', 'VectraHealth'), ('script', 'NessusLaunchScan'), ('playbook', 'close_incident_if_duplicate_found'), ('script', 'VectraHosts'), ('script', 'CPShowBackupStatus'), ('playbook', 'Endpoint Enrichment - Generic v2'), ('script', '3dd62013-4fed-43eb-8ae4-91b1b4250599'), ('script', 'GoogleAuthURL'), ('script', 'WildfireReport'), ('script', 'ParseEmailFile'), ('playbook', 'PanoramaCommitConfiguration'), ('script', 'IncidentSet'), ('script', 'QrSearches'), ('playbook', 'playbook5'), ('playbook', 'Failed Login Playbook With Slack'), ('script', '514ec833-c02c-49a3-8ac6-d982198f5fa0'), ('script', 'ADIsUserMember'), ('script', 'GoogleappsGmailGetMail'), ('playbook', 'block_indicators_-_generic'), ('playbook', 'dedup_-_generic'), ('integration', 'Palo Alto Networks Cortex'), ('script', 'CPShowHosts'), ('playbook', 'extract_indicators_from_file_-_generic'), ('script', 'EPORepoList'), ('script', 'EPOUpdateEndpoints'), ('script', 'CYFileRep'), ('script', 'VectraSummary'), ('script', 'ADListUsers'), ('script', 'CPBlockIP'), ('script', 'ADGetComputer'), ('playbook', 'calculate_severity_-_critical_assets'), ('script', 'VectraGetDetetctionsById'), ('playbook', 'Calculate Severity - Generic'), ('script', 'SplunkSearch'), ('script', 'BlockIP'), ('script', 'RunSqlQuery'), ('integration', 'Pwned'), ('script', '82764532-0a4f-4b59-8cf9-fe1a00cabdae'), ('integration', 'PostgreSQL'), ('script', 'a6e348f4-1e40-4365-870c-52139c60779a'), ('playbook', 'account_enrichment_-_generic'), ('script', 'ExtractURL'), ('playbook', 'get_file_sample_by_hash_-_generic'), ('script', 'TaniumAskQuestionComplex'), ('script', 'CPCreateBackup'), ('script', 'AwsCreateImage'), ('script', 'PWEvents'), ('script', 'WildfireUpload'), ('playbook', 'PAN-OS EDL Setup v2'), ('script', 'QrOffenses'), ('script', 'JiraCreateIssue'), ('script', 'PWObservationPcapInfo'), ('script', 'SNUpdateTicket'), ('script', 'GoogleappsGetUserRoles'), ('playbook', 'Endpoint data collection'), ('script', 'SlackSend'), ('script', 'EsmExample'), ('script', '2aa9f737-8c7c-42f5-815f-4d104bb3af06'), ('script', 'da330ce7-3a93-430c-8454-03b96cf5184e'), ('playbook', 'PanoramaQueryTrafficLogs'), ('script', 'PWEventPcapInfo'), ('script', 'ADUserLogonInfo'), ('script', 'AwsCreateVolumeSnapshot'), ('script', 'TaniumDeployAction'), ('script', 'ExtractDomainFromURL'), ('playbook', 'playbook10'), ('playbook', 'Enrichment Playbook'), ('script', 'ADGetGroupComputers'), ('playbook', 'ip_enrichment_generic'), ('script', 'ADGetUsersByEmail'), ('script', 'AggregateIOCs'), ('playbook', 'playbook11'), ('script', 'QrGetSearch'), ('script', 'EPORetrieveCurrentDATVersion'), ('script', 'f99a85a6-c572-4c3a-8afd-5b4ac539000a'), ('integration', 'MISP'), ('script', 'CSCountDevicesForIOC'), ('script', 'EPODetermineRepository'), ('integration', 'LightCyber Magna'), ('script', 'IncidentToContext'), ('classifier', '5c83f473-c618-4c41-85d8-251eb1f90566'), ('script', 'CPDeleteRule'), ('playbook', 'search_endpoints_by_hash_-_carbon_black_response'), ('script', '840aa9a7-04b2-4505-8238-8fe85f010dde'), ('script', 'CBSearch'), ('script', 'ADGetCommonGroups'), ('script', '80b5c44c-4eac-4e00-812f-6d409d57be31'), ('integration', 'CVE Search'), ('script', 'NessusScanDetails'), ('script', 'SendEmail'), ('script', 'LCMDetectedIndicators'), ('script', 'VectraTriage'), ('script', 'ADListComputers'), ('playbook', 'Hunt Extracted Hashes'), ('integration', 'Symantec Endpoint Protection'), ('script', 'JiraIssueAddLink'), ('integration', 'Kenna'), ('script', 'NessusGetReport'), ('script', 'GetDuplicatesMl'), ('playbook', 'Hunt for bad IOCs'), ('playbook', 'malware_investigation-_generic_-_setup'), ('script', 'TaniumApprovePendingActions'), ('script', '94f72ed9-49c8-40e5-89bb-7c98f914d2cc'), ('integration', 'ExtraHop'), ('script', 'DataDomainReputation'), ('script', 'SNOpenTicket'), ('script', 'XBNotable'), ('playbook', 'block_file_-_generic'), ('playbook', 'Phishing Investigation - Generic'), ('script', 'CommonIntegrationPython'), ('integration', 'Intezer'), ('script', 'JiraIssueAddComment'), ('playbook', 'endpoint_enrichment_-_generic'), ('playbook', 'File Enrichment - Generic'), ('playbook', 'Account Enrichment - Generic v2'), ('script', 'ProofpointDecodeURL'), ('script', 'AdSearch'), ('integration', 'Lastline'), ('script', 'IngestCSV'), ('script', 'EPORepositoryComplianceCheck'), ('script', 'IPInfoQuery'), ('script', 'DBotTrainTextClassifier'), ('integration', 'jira'), ('script', 'CPTaskStatus'), ('script', 'ConferIncidentDetails'), ('script', 'LocateAttachment'), ('script', 'NessusHostDetails'), ('playbook', 'domain_enrichment_generic'), ('script', 'HTMLDocsAutomation'), ('script', 'DefaultIncidentClassifier'), ('script', 'ADSetNewPassword'), ('integration', 'Palo Alto Minemeld'), ('script', 'ADGetComputerGroups'), ('script', 'SlackAskUser'), ('script', 'LCMHosts'), ('script', 'TriagePhishing'), ('integration', 'OPSWAT-Metadefender'), ('script', 'PanoramaPcaps'), ('script', 'SandboxDetonateFile'), ('script', 'ExchangeDeleteMail'), ('integration', 'Cylance Protect'), ('script', 'MD5Extract'), ('script', 'ExposeModules'), ('script', 'ADGetEmailForUser'), ('script', 'ADGetGroupUsers'), ('script', 'PanoramaConfig'), ('script', 'ExposeList'), ('playbook', 'playbook16'), ('integration', 'AlienVault OTX'), ('integration', 'Proofpoint TAP'), ('playbook', 'PANW - Hunting and threat detection by indicator type V2'), ('script', 'ADExpirePassword'), ('script', 'CBFindHash'), ('script', 'ExtractHash'), ('script', 'ClassifierNotifyAdmin'), ('script', 'EPOUpdateRepository'), ('playbook', 'QRadar - Get offense correlations '), ('script', 'EPOCheckLatestDAT'), ('script', 'DataURLReputation'), ('integration', 'EWS'), ('playbook', 'url_enrichment_-_generic'), ('script', 'NessusCreateScan'), ('script', 'TaniumFindRunningProcesses'), ('script', 'DataIPReputation'), ('script', 'WhoisSummary'), ('script', 'DocumentationAutomation'), ('script', 'PanoramaBlockIP'), ('script', 'ExchangeDeleteIDsFromContext'), ('playbook', 'email_address_enrichment_-_generic'), ('script', 'PWFindEvents'), ('playbook', 'Demisto_Self-Defense_-_Account_policy_monitoring_playbook'), ('script', 'VectraClassifier'), ('integration', 'WildFire'), ('script', 'BinaryReputationPy'), ('script', 'IPExtract'), ('integration', 'Cymon'), ('script', 'InviteUser'), ('playbook', 'Carbon Black Rapid IOC Hunting'), ('integration', 'Mimecast'), ('script', 'ADGetUserGroups'), ('script', 'PanoramaDynamicAddressGroup'), ('playbook', 'search_endpoints_by_hash_-_generic'), ('script', 'XBUser'), ('script', 'SlackMirror'), ('script', 'ADGetAllUsersEmail'), ('playbook', 'PANW - Hunting and threat detection by indicator type'), ('playbook', 'playbook7'), ('integration', 'Shodan'), ('script', 'SearchIncidents'), ('script', 'NetwitnessSAUpdateIncident'), ('integration', 'Amazon Web Services'), ('playbook', 'Email Address Enrichment - Generic v2'), ('script', 'JiraIssueQuery'), ('script', 'CheckFilesWildfirePy'), ('script', '7b02fa0f-94ff-48c7-8350-b4e353702e73'), ('script', 'TaniumShowPendingActions'), ('integration', 'Azure Compute'), ('script', '10cb3486-48f3-4d93-88af-b6be84ffd432'), ('script', 'LCMDetectedEntities'), ('integration', 'SafeBreach'), ('script', 'TaniumAskQuestion'), ('script', 'SetSeverityByScore'), ('script', 'XBTriggeredRules'), ('script', 'CSActors'), ('playbook', 'Account Enrichment'), ('script', 'NessusScanStatus'), ('script', 'SNListTickets'), ('playbook', 'dedup_incidents_-_ml'), ('script', 'PanoramaMove'), ('integration', 'ArcSight ESM'), ('playbook', 'PAN-OS EDL Setup'), ('integration', 'Mimecast Authentication'), ('playbook', 'playbook13'), ('playbook', 'vulnerability_handling_-_qualys'), ('script', 'ElasticSearchDisplay'), ('script', 'CSHuntByIOC'), ('script', 'SplunkEmailParser'), ('script', 'JiraIssueUploadFile')}, 'Inventa': {('playbook', 'DSAR Inventa Handler'), ('integration', 'Inventa'), ('incidenttype', 'iDSAR')}, 'CrowdStrikeFalconStreamingV2': {('classifier', 'crowdstrike-streaming-api'), ('mapper', 'crowdstrike-streaming-api-mapper'), ('script', 'CrowdStrikeStreamingPreProcessing'), ('classifier', '5d9a5ec5-33cb-4f82-8c5e-e8ae6f7831d8'), ('integration', 'CrowdStrike Falcon Streaming v2')}, 'IntegrationsAndIncidentsHealthCheck': {('incidenttype', 'Integrations and Incidents Health Check'), ('script', 'IncidentsCheck-Widget-CreationDate'), ('script', 'IntegrationsCheck-Widget-IntegrationsErrorsInfo'), ('script', 'IncidentsCheck-Widget-PlaybookNames'), ('script', 'IncidentsCheck-Widget-CommandsNames'), ('playbook', 'JOB - Integrations and Playbooks Health Check - Lists handling'), ('script', 'InstancesCheck-FailedCategories'), ('script', 'IntegrationsCheck-Widget-NumberChecked'), ('script', 'IncidentsCheck-NumberofIncidentsNoOwner'), ('script', 'IncidentsCheck-NumberofTotalEntriesErrors'), ('script', 'GetFailedTasks'), ('script', 'IncidentsCheck-Widget-UnassignedFailingIncidents'), ('playbook', 'Integrations and Playbooks Health Check - Running Scripts'), ('script', 'IncidentsCheck-Widget-NumberFailingIncidents'), ('script', 'IncidentsCheck-NumberofIncidentsWithErrors'), ('playbook', 'JOB - Integrations and Playbooks Health Check'), ('script', 'IntegrationsCheck-Widget-NumberFailingInstances'), ('script', 'IncidentsCheck-Widget-IncidentsErrorsInfo'), ('script', 'IncidentsCheck-Widget-NumberofErrors'), ('script', 'InstancesCheck-NumberofFailedInstances'), ('script', 'CopyLinkedAnalystNotes'), ('script', 'IntegrationsCheck-Widget-IntegrationsCategory'), ('script', 'IncidentsCheck-PlaybooksFailingCommands'), ('script', 'IncidentsCheck-PlaybooksHealthNames'), ('script', 'InstancesCheck-NumberofEnabledInstances'), ('script', 'RestartFailedTasks')}, 'TIM_SIEM': {('playbook', 'TIM - Add Domain Indicators To SIEM'), ('playbook', 'TIM - Add IP Indicators To SIEM'), ('playbook', 'TIM - Add Bad Hash Indicators To SIEM'), ('playbook', 'TIM - Add Url Indicators To SIEM'), ('playbook', 'TIM - Add All Indicator Types To SIEM')}, 'ShiftManagement': {('script', 'GetUsersOOO'), ('script', 'GetUsersOnCall'), ('script', 'OutOfOfficeListCleanup'), ('script', 'GetAwayUsers'), ('script', 'GetNumberOfUsersOnCall'), ('script', 'GetShiftsPerUser'), ('script', 'GetRolesPerShift'), ('script', 'ManageOOOusers'), ('script', 'GetOnCallHoursPerUser'), ('incidenttype', 'Shift handover'), ('script', 'AssignAnalystToIncidentOOO'), ('script', 'AssignToNextShiftOOO'), ('playbook', 'Shift handover'), ('playbook', 'Assign Active Incidents to Next Shift V2'), ('playbook', 'Set up a Shift handover meeting'), ('script', 'TimeToNextShift'), ('script', 'CreateChannelWrapper')}, 'EmployeeOffboarding': {('playbook', 'IT - Employee Offboarding'), ('playbook', 'Employee Offboarding - Revoke Permissions'), ('playbook', 'Employee Offboarding - Gather User Information'), ('playbook', 'Employee Offboarding - Retain & Delete'), ('incidenttype', 'Employee Offboarding'), ('playbook', 'IT - Employee Offboarding - Manual'), ('playbook', 'Employee Offboarding - Delegate')}, 'Campaign': {('script', 'GetSendEmailInstances'), ('script', 'GetCampaignIncidentsInfo'), ('script', 'ShowCampaignLastIncidentOccurred'), ('script', 'SplitCampaignContext'), ('script', 'ShowCampaignIncidentsOwners'), ('script', 'GetCampaignIndicatorsByIncidentId'), ('script', 'GetCampaignDuration'), ('script', 'ShowCampaignRecipients'), ('script', 'ShowNumberOfCampaignIncidents'), ('script', 'ShowCampaignSenders'), ('script', 'ShowCampaignUniqueRecipients'), ('script', 'PerformActionOnCampaignIncidents'), ('script', 'CollectCampaignRecipients'), ('script', 'SendEmailToCampaignRecipients'), ('incidenttype', 'Phishing Campaign'), ('script', 'ShowCampaignHighestSeverity'), ('script', 'GetCampaignLowSimilarityIncidentsInfo'), ('script', 'GetCampaignIncidentsIdsAsOptions'), ('script', 'GetCampaignLowerSimilarityIncidentsIdsAsOptions'), ('script', 'FindEmailCampaign'), ('script', 'IsIncidentPartOfCampaign'), ('script', 'ShowCampaignUniqueSenders'), ('script', 'ShowCampaignSimilarityRange'), ('playbook', 'Detect & Manage Phishing Campaigns'), ('script', 'SetPhishingCampaignDetails')}, 'TIM_Processing': {('playbook', 'TIM - Run Enrichment For IP Indicators'), ('playbook', 'TIM - Update Indicators Organizational External IP Tag'), ('playbook', 'TIM - Process CIDR Indicators By Size'), ('playbook', 'TIM - Process Indicators Against Business Partners IP List'), ('playbook', 'TIM - Run Enrichment For Domain Indicators'), ('playbook', 'TIM - Process Indicators Against Business Partners URL List'), ('playbook', 'TIM - Process Indicators Against Business Partners Domains List'), ('incidenttype', 'Review Indicators Manually'), ('playbook', 'TIM - Run Enrichment For Url Indicators'), ('playbook', 'TIM - Process Indicators - Fully Automated'), ('playbook', 'TIM - Review Indicators Manually For Whitelisting'), ('playbook', 'TIM - Process File Indicators With File Hash Type'), ('playbook', 'TIM - Process Indicators Against Approved Hash List'), ('playbook', 'TIM - Indicator Auto Processing'), ('playbook', 'TIM - Process Indicators Against Organizations External IP List'), ('playbook', 'TIM - Run Enrichment For All Indicator Types'), ('playbook', 'TIM - Run Enrichment For Hash Indicators'), ('incidenttype', 'Review Indicators Manually For Whitelisting'), ('playbook', 'TIM - Process Indicators - Manual Review'), ('playbook', 'TIM - Indicators Exclusion By Related Incidents'), ('playbook', 'TIM - Review Indicators Manually')}, 'ThreatIntelReports': {('script', 'UnpublishThreatIntelReport'), ('script', 'PublishThreatIntelReport')}, 'CommonWidgets': {('script', 'GetLargestInputsAndOuputsInIncidents'), ('script', 'RSSWidget'), ('script', 'FeedIntegrationErrorWidget'), ('script', 'MyToDoTasksWidget'), ('script', 'GetLargestInvestigations')}, 'EmailCommunication': {('classifier', '0cc88f85-97b7-452e-839c-b58daf0bcf8d'), ('mapper', '4f31271a-c22a-4615-862d-2e315778676e'), ('classifier', '18a9fa04-f6e5-43cc-8427-a2ac0d94a8a2'), ('classifier', 'MS Graph Mail Single User - Classifier - Email Communication'), ('script', 'SendEmailReply'), ('incidenttype', 'Email Communication'), ('mapper', 'e92f424d-51f4-4d7c-8e35-502f2a4dac02'), ('mapper', 'fd0fde44-a619-4273-8c70-569f6620d759'), ('script', 'PreprocessEmail'), ('script', 'DisplayEmailHtml'), ('classifier', '83d66f08-42b4-4ca6-8145-99bcf7c6b8e5'), ('classifier', 'faa1bfc8-09cd-44e0-81fe-73092e735916'), ('classifier', '173a8bc5-663b-4478-89a5-d2ce2ce8a31f'), ('classifier', '6f81fb48-73d0-4f7f-8d3e-9c586ecec38a'), ('classifier', 'faa1bfc8-37cd-44e0-81fe-73092e381563'), ('mapper', 'MS Graph Mail Single User - Incoming Mapper - Email Communication')}, 'IAM-SCIM': {('mapper', 'User Profile - SCIM (Outgoing)'), ('mapper', 'User Profile - SCIM (Incoming)')}}
    # excluded_items_by_type = {'integration': {'Cortex XDR - IOC', 'Mimecast', 'Symantec Endpoint Protection', 'Azure Compute', 'Secdo', 'Azure Security Center', 'ExpanseV2', 'ArcSight ESM', 'Amazon Web Services', 'SafeBreach', 'ExtraHop', 'Cylance Protect', 'Proofpoint TAP', 'Inventa', 'Cymon', 'Shodan', 'FeedExpanse', 'Pwned', 'CrowdStrike Falcon Streaming v2', 'EWS', 'Traps', 'Cortex XDR - IR', 'Palo Alto Minemeld', 'Cortex XDR - XQL Query Engine', 'MISP', 'WildFire', 'OPSWAT-Metadefender', 'Phishme Intelligence', 'CVE Search', 'Expanse', 'Lastline', 'PostgreSQL', 'Mimecast Authentication', 'LightCyber Magna', 'Kenna', 'Intezer', 'AlienVault OTX', 'Palo Alto Traps ESM (Beta)', 'Lockpath KeyLight', 'Palo Alto Networks Cortex', 'jira'}, 'playbook': {'playbook13', 'malware_investigation-_generic_-_setup', 'playbook12', 'Traps Retrieve And Download Files', 'IT - Employee Offboarding - Manual', 'Endpoint Enrichment - Generic v2', 'TIM - Process Indicators Against Approved Hash List', 'Cortex XDR - Check Action Status', 'TIM - Review Indicators Manually For Whitelisting', 'Cortex XDR - delete file', 'extract_indicators_-_generic', 'playbook14', 'TIM - Add All Indicator Types To SIEM', 'DBotCreatePhishingClassifierJob', 'url_enrichment_-_generic', 'TIM - Process Indicators - Manual Review', 'TIM - Run Enrichment For IP Indicators', 'Expanse Attribution', 'Cortex XDR - AWS IAM user access investigation', 'Enrich McAfee DXL using 3rd party sandbox', 'get_file_sample_by_hash_-_generic', 'playbook5', 'playbook7', 'Traps Quarantine Event', 'playbook10', 'TIM - Indicator Auto Processing', 'Account Enrichment - Generic v2', 'TIM - Review Indicators Manually', 'File Enrichment - Generic', 'domain_enrichment_generic', 'Email Address Enrichment - Generic v2', 'Get Mails By Folder Pathes', 'PANW - Hunting and threat detection by indicator type V2', 'TIM - Add IP Indicators To SIEM', 'Cortex XDR Incident Handling', 'Employee Offboarding - Gather User Information', 'close_incident_if_duplicate_found', 'ExpanseParseRawIncident', 'Traps Scan Endpoint', 'Calculate Severity - Generic', 'Expanse VM Enrich', 'endpoint_enrichment_-_generic', 'Cortex XDR - quarantine file', 'add_indicator_to_miner_-_palo_alto_mineMeld', 'search_endpoints_by_hash_-_generic', 'Cortex XDR - Retrieve File Playbook', 'Hunt for bad IOCs', 'Employee Offboarding - Revoke Permissions', 'Cortex XDR - check file existence', 'TIM - Add Bad Hash Indicators To SIEM', 'PAN-OS EDL Setup', 'IT - Employee Offboarding', 'block_ip_-_generic', 'email_address_enrichment_-_generic', 'JOB - Integrations and Playbooks Health Check', 'Failed Login Playbook With Slack', 'Extract and Enrich Expanse Indicators', 'Expanse Behavior Severity Update', 'dedup_incidents_-_ml', 'block_indicators_-_generic', 'Cortex XDR device control violations', 'Phishing Investigation - Generic', 'Palo Alto Networks - Endpoint Malware Investigation v2', 'account_enrichment_-_generic', 'Endpoint data collection', 'TIM - Process CIDR Indicators By Size', 'Cortex XDR - Isolate Endpoint', 'PANW - Hunting and threat detection by indicator type', 'TIM - Add Url Indicators To SIEM', 'Cortex XDR - Run script', 'search_endpoints_by_hash_-_carbon_black_response', 'playbook11', 'Handle Expanse Incident - Attribution Only', 'Carbon Black Rapid IOC Hunting', 'vulnerability_handling_-_qualys', 'PAN-OS - Block IP and URL - External Dynamic List', 'ip_enrichment_generic', 'TIM - Run Enrichment For Url Indicators', 'Employee Offboarding - Retain & Delete', 'Traps Isolate Endpoint', 'Demisto_Self-Defense_-_Account_policy_monitoring_playbook', 'TIM - Run Enrichment For All Indicator Types', 'Expanse Load-Create List', 'Expanse Enrich Cloud Assets', 'TIM - Indicators Exclusion By Related Incidents', 'Failed Login Playbook - Slack v2', 'Cortex XDR disconnected endpoints', 'DSAR Inventa Handler', 'QRadar - Get offense correlations ', 'entity_enrichment_generic', 'Assign Active Incidents to Next Shift V2', 'JOB - Integrations and Playbooks Health Check - Lists handling', 'PanoramaCommitConfiguration', 'TIM - Process Indicators - Fully Automated', 'Traps Blacklist File', 'Enrichment Playbook', 'extract_indicators_from_file_-_generic', 'TIM - Process Indicators Against Business Partners URL List', 'playbook1', 'Account Enrichment', 'TIM - Update Indicators Organizational External IP Tag', 'Cortex XDR - Execute snippet code script', 'ExtraHop - Ticket Tracking', 'Integrations and Playbooks Health Check - Running Scripts', 'TIM - Add Domain Indicators To SIEM', 'playbook16', 'PanoramaQueryTrafficLogs', 'calculate_severity_-_critical_assets', 'TIM - Run Enrichment For Hash Indicators', 'Xpanse Incident Handling - Generic', 'Cortex XDR - Execute commands', 'Shift handover', 'Cortex XDR - Port Scan - Adjusted', 'Cortex XDR incident handling v3', 'Incident Enrichment', 'Cortex XDR Alerts Handling', 'Process Email', 'Cortex XDR - Block File', 'TIM - Process Indicators Against Business Partners Domains List', 'Hunt Extracted Hashes', 'Set up a Shift handover meeting', 'vulnerability_handling_-_qualys_-_add _ustom_fields_to_default_layout', 'Enrich DXL with ATD verdict', 'TIM - Process Indicators Against Business Partners IP List', 'Cortex XDR - kill process', 'Cortex XDR - Port Scan', 'Expanse Unmanaged Cloud', 'Handle Expanse Incident', 'TIM - Process Indicators Against Organizations External IP List', 'TIM - Process File Indicators With File Hash Type', 'malware_investigation-_generic', 'DBotCreatePhishingClassifier', 'JOB - Cortex XDR query endpoint device control violations', 'Cortex XDR - Unisolate Endpoint', 'Cortex XDR incident handling v2', 'NSA - 5 Security Vulnerabilities Under Active Nation-State Attack', 'Cortex XDR Incident Sync', 'PAN-OS EDL Setup v2', 'Cortex XDR - PrintNightmare Detection and Response', 'Employee Offboarding - Delegate', 'Cortex XDR - Malware Investigation', 'Expanse Find Cloud IP Address Region and Service', 'TIM - Run Enrichment For Domain Indicators', 'Detect & Manage Phishing Campaigns', 'block_file_-_generic', 'dedup_-_generic', 'process_email_-_add_custom_fields'}, 'script': {'TaniumFindRunningProcesses', 'UnpublishThreatIntelReport', '94f72ed9-49c8-40e5-89bb-7c98f914d2cc', 'EPOUpdateRepository', 'CheckIPs', 'GoogleappsRevokeUserRole', 'SNListTickets', 'PanoramaConfig', 'PWEventPcapInfo', 'ShowCampaignUniqueSenders', 'JiraIssueQuery', 'XBNotable', 'CreateChannelWrapper', 'AwsStopInstance', 'ManageOOOusers', 'SendEmailToCampaignRecipients', 'ConferIncidentDetails', 'CommonIntegrationPython', 'CollectCampaignRecipients', 'TriagePhishing', 'EPODetermineRepository', 'IngestCSV', 'NessusShowEditorTemplates', 'PWObservationDetails', 'NessusListScans', 'GetNumberOfUsersOnCall', 'GetUsersOOO', 'NessusScanStatus', 'ExpanseRefreshIssueAssets', 'PWObservationPcapInfo', 'InviteUser', 'AwsStartInstance', 'IsIncidentPartOfCampaign', 'QrSearches', 'GetShiftsPerUser', 'GetLargestInputsAndOuputsInIncidents', 'IncidentsCheck-NumberofTotalEntriesErrors', 'ShowCampaignSimilarityRange', 'a6e348f4-1e40-4365-870c-52139c60779a', 'XBLockouts', 'CPShowHosts', 'ADGetComputerGroups', 'CPShowBackupStatus', 'ShowCampaignSenders', 'XBInfo', 'JiraIssueAddComment', 'IsContextSet', 'GetCampaignIncidentsIdsAsOptions', 'VectraHealth', 'QrOffenses', '2aa9f737-8c7c-42f5-815f-4d104bb3af06', 'GetRolesPerShift', 'GetSendEmailInstances', 'AwsCreateVolumeSnapshot', 'JiraGetIssue', 'PWObservations', 'InstancesCheck-FailedCategories', 'EPORepositoryComplianceCheck', 'XBTimeline', 'IncidentsCheck-Widget-CreationDate', 'GoogleappsGmailGetMail', 'IncidentToContext', 'IntegrationsCheck-Widget-NumberChecked', 'QrGetSearchResults', 'ExchangeDeleteMail', 'DBotPreparePhishingData', 'CheckFiles', 'XDRDisconnectedEndpoints', 'ExtractDomain', 'ExpanseAggregateAttributionCI', 'CPSetRule', 'PerformActionOnCampaignIncidents', 'DefaultIncidentClassifier', 'ADListUsersEx', 'QrFullSearch', 'ExposeModules', 'ExtractIP', 'EPORepoList', 'WildfireUpload', '9364c36f-b1d6-4233-88c2-75008b106c31', 'VectraTriage', 'IncidentsCheck-Widget-NumberofErrors', 'JiraCreateIssue', 'ADGetGroupUsers', 'AdSearch', 'CSCountDevicesForIOC', 'PWEvents', 'CrowdStrikeStreamingPreProcessing', 'ExpanseEnrichAttribution', 'ExpanseParseRawIncident', 'IncidentsCheck-PlaybooksHealthNames', 'SetPhishingCampaignDetails', 'ExchangeSearchMailbox', 'NessusHostDetails', 'ADGetGroupMembers', 'ADExpirePassword', 'ReadPDFFile', 'SendEmailReply', '840aa9a7-04b2-4505-8238-8fe85f010dde', 'ClassifierNotifyAdmin', 'GetContextValue', 'SetIncidentCustomFields', 'IncidentsCheck-Widget-PlaybookNames', 'ExchangeDeleteIDsFromContext', 'MyToDoTasksWidget', 'LCMResolveHost', 'DemistoDeleteIncident', 'LCMAcknowledgeHost', 'ExchangeSearch', '10cb3486-48f3-4d93-88af-b6be84ffd432', 'LCMPathFinderScanHost', 'ExpanseAggregateAttributionUser', 'CortexXDRRemediationActionsWidget', 'CortexXDRCloudProviderWidget', 'CBSearch', 'CPBlockIP', 'CheckURLs', 'LCMDetectedIndicators', 'GetDuplicatesMl', 'DBotPredictTextLabel', 'WhoisSummary', 'VectraSettings', 'CPCreateBackup', 'ExposeList', 'CPTaskStatus', 'NessusLaunchScan', 'GetCampaignLowerSimilarityIncidentsIdsAsOptions', 'DataIPReputation', 'CPDeleteRule', 'SendEmail', 'XBUser', 'AwsRunInstance', 'SplunkSearch', 'getMlFeatures', 'EsmExample', 'RSSWidget', 'ParseEmailFile', 'PublishThreatIntelReport', 'EntryWidgetPieAlertsXDR', 'TaniumAskQuestion', 'DisplayEmailHtml', 'SlackMirror', 'ProofpointDecodeURL', 'ShowNumberOfCampaignIncidents', '82764532-0a4f-4b59-8cf9-fe1a00cabdae', 'TaniumApprovePendingActions', 'da330ce7-3a93-430c-8454-03b96cf5184e', 'FindEmailCampaign', 'ADGetUserGroups', 'IncidentsCheck-Widget-IncidentsErrorsInfo', 'TimeToNextShift', 'ADListComputers', 'ShowCampaignLastIncidentOccurred', 'ADGetComputer', 'VectraGetDetetctionsById', 'SetSeverityByScore', 'ADListUsers', 'GetLargestInvestigations', 'CheckFilesWildfirePy', 'RunSqlQuery', 'IPExtract', 'LCMSetHostComment', 'GoogleappsGmailSearch', 'ExpanseAggregateAttributionIP', 'SearchIncidents', 'ADGetEmailForUser', 'LCMDetectedEntities', 'DBotGroupXDRIncidents', 'CYFileRep', 'CSActors', 'LCMHosts', 'XDRConnectedEndpoints', 'EPOUpdateEndpoints', 'IntegrationsCheck-Widget-IntegrationsErrorsInfo', '514ec833-c02c-49a3-8ac6-d982198f5fa0', '80b5c44c-4eac-4e00-812f-6d409d57be31', 'ADGetEmailForAllUsers', 'ADIsUserMember', 'ADGetGroupComputers', 'SplitCampaignContext', '7b02fa0f-94ff-48c7-8350-b4e353702e73', 'QrGetSearch', 'EPORetrieveCurrentDATVersion', 'BinaryReputationPy', 'ParseEmailHeader', 'GetCampaignIndicatorsByIncidentId', 'AwsCreateImage', 'DataURLReputation', 'SandboxDetonateFile', 'EPOCheckLatestDAT', 'PanoramaPcaps', 'IncidentsCheck-NumberofIncidentsWithErrors', 'NessusScanDetails', 'CBFindHash', 'XDRSyncScript', 'NetwitnessSAUpdateIncident', 'ExpanseAggregateAttributionDevice', 'IntegrationsCheck-Widget-IntegrationsCategory', 'WildfireReport', 'IncidentsCheck-Widget-NumberFailingIncidents', 'ExtractURL', 'CopyLinkedAnalystNotes', 'PreprocessEmail', 'Elasticsearch', 'PanoramaBlockIP', 'AssignAnalystToIncidentOOO', 'ADSetNewPassword', 'IncidentsCheck-Widget-UnassignedFailingIncidents', 'IPInfoQuery', '3dd62013-4fed-43eb-8ae4-91b1b4250599', 'PWEventDetails', 'IncidentsCheck-PlaybooksFailingCommands', 'dbbdc2e4-6105-4ee9-8e83-563a4b991a89', 'FeedIntegrationErrorWidget', 'ExposeUsers', 'ADGetAllUsersEmail', 'NessusGetReport', 'CommonIntegration', 'GoogleappsGetUserRoles', '7b5c080e-f3b1-411a-83b0-e1f53c21bef8', 'HTMLDocsAutomation', 'MatchIPinCIDRIndicators', 'InstancesCheck-NumberofEnabledInstances', 'XBTriggeredRules', 'VectraSummary', 'JiraIssueUploadFile', 'SlackAskUser', 'VectraSensors', 'AggregateIOCs', 'DBotTrainTextClassifier', 'RestartFailedTasks', 'DocumentationAutomation', 'PWSensors', 'DataHashReputation', 'CPShowAccessRulebase', 'GoogleappsListUsers', 'DBotPredictPhishingLabel', 'LocateAttachment', 'MD5Extract', 'OutOfOfficeListCleanup', 'DataDomainReputation', 'VectraHosts', 'BlockIP', 'ExtractEmail', 'ShowCampaignUniqueRecipients', 'CSHuntByIOC', 'ADGetCommonGroups', 'ExtractDomainFromURL', 'ADGetUsersByEmail', 'NessusCreateScan', 'JiraIssueAddLink', 'ExtractHash', 'IsIPInSubnet', 'PanoramaCommit', 'CloseInvestigation', 'ShowCampaignRecipients', 'TaniumShowPendingActions', 'PanoramaDynamicAddressGroup', 'ShowCampaignHighestSeverity', 'VectraClassifier', 'SNOpenTicket', 'ADUserLogonInfo', 'TaniumDeployAction', 'f99a85a6-c572-4c3a-8afd-5b4ac539000a', 'SplunkSearchJsonPy', 'IntegrationsCheck-Widget-NumberFailingInstances', 'InstancesCheck-NumberofFailedInstances', 'PWFindEvents', 'IncidentsCheck-NumberofIncidentsNoOwner', 'GetUsersOnCall', 'ExchangeAssignRole', 'GetCampaignDuration', 'LCMIndicatorsForEntity', 'EntryWidgetNumberUsersXDR', 'ExpanseEvidenceDynamicSection', 'GetCampaignIncidentsInfo', 'PanoramaMove', 'SplunkEmailParser', 'GetOnCallHoursPerUser', 'IncidentsCheck-Widget-CommandsNames', 'CSIndicators', 'GetFailedTasks', 'CortexXDRIdentityInformationWidget', 'GetCampaignLowSimilarityIncidentsInfo', 'URLExtract', 'EntryWidgetNumberHostsXDR', 'VectraDetections', 'ElasticSearchDisplay', 'DBotPredictPhishingEvaluation', 'IncidentSet', 'ExpanseGenerateIssueMapWidgetScript', 'SNUpdateTicket', 'VectraGetHostById', 'CortexXDRAdditionalAlertInformationWidget', 'GoogleAuthURL', 'ExpansePrintSuggestions', 'AssignToNextShiftOOO', 'AwsGetInstanceInfo', 'CheckWhitelist', 'ConferSetSeverity', 'GoogleappsGetUser', 'TaniumAskQuestionComplex', 'SlackSend', 'ShowCampaignIncidentsOwners', 'GetAwayUsers'}, 'classifier': {'faa1bfc8-37cd-44e0-81fe-73092e381563', '83d66f08-42b4-4ca6-8145-99bcf7c6b8e5', '173a8bc5-663b-4478-89a5-d2ce2ce8a31f', '6f81fb48-73d0-4f7f-8d3e-9c586ecec38a', '18a9fa04-f6e5-43cc-8427-a2ac0d94a8a2', '95573d05-345e-43b6-82f1-a5a8ad402e69', 'MS Graph Mail Single User - Classifier - Email Communication', 'faa1bfc8-09cd-44e0-81fe-73092e735916', 'ExpanseV2', 'crowdstrike-streaming-api', '0cc88f85-97b7-452e-839c-b58daf0bcf8d', '32f26072-9a69-41a5-8db8-0d1226431078', 'Cortex XDR - IR', '5d9a5ec5-33cb-4f82-8c5e-e8ae6f7831d8', '5c83f473-c618-4c41-85d8-251eb1f90566'}, 'incidenttype': {'Cortex XDR Port Scan', 'Xpanse Issue - Generic', 'Employee Offboarding', 'Expanse Issue', 'Shift handover', 'Email Communication', 'Review Indicators Manually For Whitelisting', 'Cortex XDR Incident', 'Cortex XDR Device Control Violations', 'Cortex XDR - XCLOUD', 'Expanse Behavior', 'Cortex XDR Disconnected endpoints', 'iDSAR', 'Expanse Appearance', 'Phishing Campaign', 'Traps', 'Integrations and Incidents Health Check', 'Review Indicators Manually'}, 'indicatorfield': {'indicator_expansedomain', 'indicator_expansedateadded', 'indicator_expanseassettype', 'indicator_expansetype', 'indicator_expanseproperties', 'indicator_expanselastobserved', 'indicator_expanseservicestatus', 'indicator_expansetenantname', 'indicator_expanseprovidername', 'indicator_expansednsresolutionstatus', 'indicator_expansesourcedomain', 'indicator_expansetags', 'indicator_xdrstatus', 'indicator_expansecertificateadvertisementstatus', 'indicator_expansebusinessunits', 'indicator_expansefirstobserved'}, 'mapper': {'crowdstrike-streaming-api-mapper', 'User Profile - SCIM (Outgoing)', 'MS Graph Mail Single User - Incoming Mapper - Email Communication', 'fd0fde44-a619-4273-8c70-569f6620d759', 'Cortex XDR - IR-mapper', '4f31271a-c22a-4615-862d-2e315778676e', 'User Profile - SCIM (Incoming)', 'Cortex XDR - IR-out-mapper', 'ExpanseV2-mapper', 'e92f424d-51f4-4d7c-8e35-502f2a4dac02'}}
    if excluded_items_by_pack:
        remove_dependencies_from_id_set(id_set, excluded_items_by_pack, excluded_items_by_type)
        id_set_creator.id_set = id_set
