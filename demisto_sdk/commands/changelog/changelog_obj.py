    ...
    def build_log(cls) -> Tuple[List[str],...]:
        ...
        for log in cls.logs:
            if log.type == LogType.breaking:
                breaking_logs.append(f"* {log.description} - [#{cls.pr_number}](https://github.com/demisto/demisto-sdk/pull/{cls.pr_number})\n")
            elif log.type == LogType.feature:
                feature_logs.append(f"* {log.description} - [#{cls.pr_number}](https://github.com/demisto/demisto-sdk/pull/{cls.pr_number})\n")
            elif log.type == LogType.fix:
                fix_logs.append(f"* {log.description} - [#{cls.pr_number}](https://github.com/demisto/demisto-sdk/pull/{cls.pr_number})\n")
