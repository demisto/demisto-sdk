...
class XsoarClient:
    ...
    def upload_file_to_war_room(self,file_path, file_name, incident_id, file_comment=None):
        return self._xsoar_client.incident_file_upload(id=incident_id, file=file_path, file_name=file_name)
