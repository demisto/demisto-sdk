...
INTEGRATION_PACKAGE_REGEX = fr'{INTEGRATIONS_DIR}\/([^\\/]+)'

PACKS_INTEGRATION_PY_REGEX = fr'{INTEGRATION_PACKAGE_REGEX}\/([^\/]+)\/\1\.py'
PACKS_INTEGRATION_TEST_PY_REGEX = fr'{INTEGRATION_PACKAGE_REGEX}/([^/]+)/\1_test\.py'
PACKS_INTEGRATION_PS_REGEX = fr'{INTEGRATION_PACKAGE_REGEX}/([^\\/]+)/\1.ps1$'
PACKS_INTEGRATION_PS_TEST_REGEX = fr'{INTEGRATION_PACKAGE_REGEX}/([^\\/]+)/\1\.Tests\.ps1$'
PACKS_INTEGRATION_YML_REGEX = fr'{INTEGRATION_PACKAGE_REGEX}/([^.]+)\.yml'
PACKS_INTEGRATION_README_REGEX = fr'{INTEGRATION_PACKAGE_REGEX}/README.md$'
PACKS_INTEGRATION_CHANGELOG_REGEX = fr'{INTEGRATION_PACKAGE_REGEX}/CHANGELOG.md$'
...
PACKS_INTEGRATION_NON_SPLIT_CHANGELOG_REGEX = fr'{PACKS_INTEGRATION_NON_SPLIT_BASE_REGEX}_CHANGELOG.md$'
...
PACKS_SCRIPT_PY_REGEX = fr'{SCRIPTS_DIR_REGEX}/([^/]+)/\2\.py'
PACKS_SCRIPT_TEST_PY_REGEX = fr'{SCRIPTS_DIR_REGEX}/([^/]+)/\2_test\.py'
PACKS_SCRIPT_PS_REGEX = fr'{SCRIPTS_DIR_REGEX}/([^\\/]+)/\1.ps1$'
PACKS_SCRIPT_PS_REGEX = fr'{SCRIPTS_DIR_REGEX}/([^\\/]+)/\1\.Tests\.ps1$'
PACKS_SCRIPT_YML_REGEX = fr'{SCRIPTS_DIR_REGEX}\/([^/]+)\/([^.]+)\.yml'
PACKS_SCRIPT_README_REGEX = fr'{SCRIPTS_DIR_REGEX}/([^\\/]+)/README.md$'
PACKS_SCRIPT_CHANGELOG_REGEX = fr'{SCRIPTS_DIR_REGEX}/([^\\/]+)/CHANGELOG.md$'

PACKS_SCRIPT_NON_SPLIT_YML_REGEX = fr'{SCRIPTS_DIR_REGEX}/script-([^\\/]+)\.yml$'
PACKS_SCRIPTS_NON_SPLIT_README_REGEX = fr'{SCRIPTS_DIR_REGEX}/script-([^\\/])+_README.md$'
PACKS_SCRIPTS_NON_SPLIT_CHANGELOG_REGEX = fr'{SCRIPTS_DIR_REGEX}/script-([^\\/])+_CHANGELOG.md$'


PACKS_LAYOUTS_DIR_REGEX = fr'{PACK_DIR_REGEX}\/{LAYOUTS_DIR}'
PACKS_LAYOUT_JSON_REGEX = fr'{PACKS_LAYOUTS_DIR_REGEX}\/([^/]+)\.json'
PACKS_LAYOUT_CHANGELOG_REGEX = fr'{PACKS_LAYOUTS_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'

PACKS_WIDGETS_DIR_REGEX = fr'{PACK_DIR_REGEX}\/{WIDGETS_DIR}'
PACKS_WIDGET_JSON_REGEX = fr'{PACKS_WIDGETS_DIR_REGEX}\/([^/]+)\.json'
PACKS_WIDGET_CHANGELOG_REGEX = fr'{PACKS_WIDGETS_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'

PACKS_DASHBOARDS_DIR_REGEX = fr'{PACK_DIR_REGEX}\/{DASHBOARDS_DIR}'
PACKS_DASHBOARD_JSON_REGEX = fr'{PACKS_DASHBOARDS_DIR_REGEX}\/([^/]+)\.json'
PACKS_DASHBOARD_CHANGELOG_REGEX = fr'{PACKS_DASHBOARDS_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'

PACKS_REPORTS_DIR_REGEX = fr'{PACK_DIR_REGEX}\/{REPORTS_DIR}'
PACKS_REPORT_JSON_REGEX = fr'{PACKS_REPORTS_DIR_REGEX}\/([^/]+)\.json'
PACKS_REPORT_CHANGELOG_REGEX = fr'{PACKS_REPORTS_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'
...
PACKS_INCIDENT_TYPE_CHANGELOG_REGEX = fr'{PACKS_INCIDENT_TYPES_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'
...
PACKS_INCIDENT_FIELD_CHANGELOG_REGEX = fr'{PACKS_INCIDENT_FIELDS_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'
...
PACKS_INDICATOR_TYPE_CHANGELOG_REGEX = fr'{PACKS_INDICATOR_TYPES_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'
...
PACKS_INDICATOR_FIELD_CHANGELOG_REGEX = fr'{PACKS_INDICATOR_FIELDS_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'
...
PLAYBOOK_CHANGELOG_REGEX = fr'{PLAYBOOK_BASE_REGEX}_CHANGELOG\.md$'
...
SCHEMA_TO_REGEX = {
    ...
    'changelog': [PACKS_INTEGRATION_CHANGELOG_REGEX,
                  PACKS_INTEGRATION_NON_SPLIT_CHANGELOG_REGEX,
                  PACKS_SCRIPT_CHANGELOG_REGEX,
                  PACKS_SCRIPTS_NON_SPLIT_CHANGELOG_REGEX,
                  PLAYBOOK_CHANGELOG_REGEX,
                  PACKS_LAYOUT_CHANGELOG_REGEX,
                  PACKS_DASHBOARD_CHANGELOG_REGEX,
                  PACKS_REPORT_CHANGELOG_REGEX,
                  PACKS_INCIDENT_FIELD_CHANGELOG_REGEX,
                  PACKS_INCIDENT_TYPE_CHANGELOG_REGEX,
                  PACKS_INDICATOR_FIELD_CHANGELOG_REGEX,
                  PACKS_INCIDENT_FIELD_CHANGELOG_REGEX,
                  ],
