...
# Agentix Actions - nested directory structure: AgentixActions/<action_id>/<action_id>.yaml
AGENTIX_ACTIONS_DIR_REGEX = rf"{PACK_DIR_REGEX}\/{AGENTIX_ACTIONS_DIR}"
AGENTIX_ACTION_PACKAGE_REGEX = rf"{AGENTIX_ACTIONS_DIR_REGEX}\/([^\\/]+)"
AGENTIX_ACTION_REGEX = rf"{AGENTIX_ACTION_PACKAGE_REGEX}\/[^/]+(?<!_test)\.ya?ml$"
AGENTIX_ACTION_TEST_REGEX = rf"{AGENTIX_ACTION_PACKAGE_REGEX}\/[^/]+_test\.ya?ml$"
