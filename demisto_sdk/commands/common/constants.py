...
CHECKED_TYPES_REGEXES = [
    ...
    SCRIPT_CHANGELOG_REGEX,
    PACKS_CHANGELOG_REGEX,
    PACKS_OLD_CHANGELOG_REGEX,
    # ReadMe,
...
SCHEMA_TO_REGEX = {
    ...
    'changelog': [INTEGRATION_CHANGELOG_REGEX, SCRIPT_CHANGELOG_REGEX, PACKS_CHANGELOG_REGEX, PACKS_OLD_CHANGELOG_REGEX,
                  INDICATOR_TYPES_CHANGELOG_REGEX, INCIDENT_TYPE_CHANGELOG_REGEX,
                  INCIDENT_FIELD_CHANGELOG_REGEX, INDICATOR_FIELD_CHANGELOG_REGEX,
