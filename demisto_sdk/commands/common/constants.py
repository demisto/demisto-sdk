...
XDRC_TEMPLATE_JSON_REGEX = rf"{XDRC_TEMPLATE_DIR_REGEX}\/([^/]+)\.json"

XDRC_TEMPLATE_DIR_REGEX = rf"{PACK_DIR_REGEX}\/{XDRC_TEMPLATE_DIR}"
XDRC_TEMPLATE_YML_REGEX = rf"{XDRC_TEMPLATE_DIR_REGEX}\/([^/]+)\.yml"
...
PARSING_RULES_YML_REGEX = rf"{PARSING_RULES_DIR_REGEX}/(?:parsingrule-)?([^/]+)\.yml"
