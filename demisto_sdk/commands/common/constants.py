...
INCIDENT_TYPE_PREFIX = 'incidenttype'
INCIDENT_FIELD_PREFIX = 'incidentfield'
INDICATOR_FIELD_PREFIX = 'indicatorfield'
...
CONTENT_PREFIXES = [
    ...
    SCRIPT_PREFIX,
    LAYOUT_PREFIX,
    INCIDENT_FIELD_PREFIX,
    INCIDENT_TYPE_PREFIX,
    INDICATOR_FIELD_PREFIX,
    CONNECTION_PREFIX,
    CLASSIFIER_PREFIX,
    DASHBOARD_PREFIX,
    REPORT_PREFIX,
...
PREFIX_TO_ENTITY = {
    INTEGRATION_PREFIX: INTEGRATIONS_DIR,
    PLAYBOOK_PREFIX: PLAYBOOKS_DIR,
    SCRIPT_PREFIX: SCRIPTS_DIR,
    LAYOUT_PREFIX: LAYOUTS_DIR,
    INCIDENT_FIELD_PREFIX: INCIDENT_FIELDS_DIR,
    INCIDENT_TYPE_PREFIX: INCIDENT_TYPES_DIR,
    INDICATOR_FIELD_PREFIX: INDICATOR_FIELDS_DIR,
    CONNECTION_PREFIX: CONNECTIONS_DIR,
    CLASSIFIER_PREFIX: CLASSIFIERS_DIR,
    DASHBOARD_PREFIX: DASHBOARDS_DIR,
    REPORT_PREFIX: REPORTS_DIR,
    WIDGET_PREFIX: WIDGETS_DIR
}
