...
OBJECT_FIELDS_DIR = 'ObjectFields'
OBJECT_TYPES_DIR = 'ObjectTypes'
OBJECT_MODULES_DIR = 'ObjectModules'
LAYOUTS_DIR = 'Layouts'
...
PACKS_OBJECT_TYPES_DIR_REGEX = fr'{PACK_DIR_REGEX}\/{OBJECT_TYPES_DIR}'
PACKS_OBJECT_TYPE_JSON_REGEX = fr'{PACKS_OBJECT_TYPES_DIR_REGEX}\/([^/]+)\.json'

PACKS_OBJECT_FIELDS_DIR_REGEX = fr'{PACK_DIR_REGEX}\/{OBJECT_FIELDS_DIR}'
PACKS_OBJECT_FIELD_JSON_REGEX = fr'{PACKS_OBJECT_FIELDS_DIR_REGEX}\/([^/]+)\.json'

PACKS_OBJECT_MODULES_DIR_REGEX = fr'{PACK_DIR_REGEX}\/{OBJECT_MODULES_DIR}'
PACKS_OBJECT_MODULE_JSON_REGEX = fr'{PACKS_OBJECT_MODULES_DIR_REGEX}\/([^/]+)\.json'
...
JSON_ALL_OBJECT_FIELDS_REGEXES = [
    PACKS_OBJECT_FIELD_JSON_REGEX,
]

JSON_ALL_OBJECT_TYPES_REGEXES = [
    PACKS_OBJECT_TYPE_JSON_REGEX,
]

JSON_ALL_OBJECT_MODULES_REGEXES = [
    PACKS_OBJECT_MODULE_JSON_REGEX,
]
...
SCHEMA_TO_REGEX = {
    ...
    'objectfield': JSON_ALL_OBJECT_FIELDS_REGEXES,
    'objecttype': JSON_ALL_OBJECT_TYPES_REGEXES,
    'objectmodule': JSON_ALL_OBJECT_MODULES_REGEXES
}
