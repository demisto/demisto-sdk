...
DEMISTO_SDK_MARKETPLACE_XSOAR_DIST = os.getenv("GCS_MARKET_BUCKET") or "marketplace-dist"
DEMISTO_SDK_MARKETPLACE_XSIAM_DIST = os.getenv("GCS_MARKET_V2_BUCKET") or  "marketplace-v2-dist"
DEMISTO_SDK_MARKETPLACE_XPANSE_DIST = os.getenv("GCS_MARKET_XPANSE_BUCKET") or "xpanse-dist"
DEMISTO_SDK_MARKETPLACE_XSOAR_SAAS_DIST = os.getenv("GCS_MARKET_XSOAR_SAAS_BUCKET") or "marketplace-saas-dist"
