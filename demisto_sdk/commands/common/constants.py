...
PACK_CHANGELOG_REGEX = fr'{PACK_DIR_REGEX}\/CHANGELOG.md$'
...
PACKS_SCRIPT_CHANGELOG_REGEX = fr'{SCRIPT_DIR_REGEX}/CHANGELOG.md$'
...
PACKS_SCRIPT_NON_SPLIT_CHANGELOG_REGEX = fr'{PACKS_SCRIPT_NON_SPLIT_BASE_REGEX}_CHANGELOG.md$'
...
PACKS_CLASSIFIER_CHANGELOG_REGEX = fr'{PACKS_CLASSIFIERS_DIR_REGEX}\/([^/]+)_CHANGELOG\.md'

# old classifier structure
_PACKS_CLASSIFIER_BASE_5_9_9_REGEX = fr'{PACKS_CLASSIFIERS_DIR_REGEX}\/*classifier-(?!mapper).*_5_9_9\.json'
PACKS_CLASSIFIER_JSON_5_9_9_REGEX = fr'{_PACKS_CLASSIFIER_BASE_5_9_9_REGEX}_CHANGELOG_5_9_9.md'
...
PACKS_MAPPER_CHANGELOG_REGEX = fr'{_PACKS_MAPPER_BASE_REGEX}_CHANGELOG.md'
...
REQUIRED_YML_FILE_TYPES = [PACKS_INTEGRATION_PY_REGEX,
                           PACKS_INTEGRATION_README_REGEX,
                           PACKS_INTEGRATION_CHANGELOG_REGEX,
                           ...
                           PACKS_SCRIPT_NON_SPLIT_CHANGELOG_REGEX,
...
SCHEMA_TO_REGEX = {
    ...
    'changelog': [PACK_CHANGELOG_REGEX,
                  PACKS_INTEGRATION_CHANGELOG_REGEX,
                  PACKS_INTEGRATION_NON_SPLIT_CHANGELOG_REGEX,
                  PACKS_SCRIPT_CHANGELOG_REGEX,
                  PACKS_SCRIPT_NON_SPLIT_CHANGELOG_REGEX,
