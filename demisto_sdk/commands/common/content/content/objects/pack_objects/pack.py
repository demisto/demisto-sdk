...
from ..pack_objects import (Integration, Script, Playbook, IncidentField, IncidentType, Classifier,
...
from ...objects_factory import ContentObjectFacotry
...
class Pack:
    ...
    def dump(self, dest_dir: Union[str, Path], integrations: bool = True, scripts: bool = True, unify: bool = True,
             ...
             tools: bool = True, change_log: bool = True, pack_ignore: bool = True,
             pre_hooks: Optional[Callable] = None,
