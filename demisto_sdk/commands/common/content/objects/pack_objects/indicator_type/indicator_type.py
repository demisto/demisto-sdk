...
class IndicatorType(JsonFile, JsonPackReadmeMixin, JsonPackVersionMixin, JsonPackDumpMixin):
    def __init__(self, path: Union[Path, str]):
        super().__init__(path=path, prefix=INDICATOR_TYPE)


class OldIndicatorType(JsonFile, JsonPackReadmeMixin, JsonPackVersionMixin, JsonPackDumpMixin):
    def __init__(self, path: Union[Path, str]):
        super().__init__(path=path, prefix=OLD_INDICATOR_TYPE)
