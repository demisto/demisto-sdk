...
class TestValidJSON:
    ...
    def test_get_item(self):
        ...
        assert (
            obj['fromVersion'] == load(TEST_VALID_JSON.open())['fromVersion']
        )

    @pytest.mark.parametrize(
        argnames='default_value', argvalues=['test_value', '']
    )
    def test_get(self, default_value: str):
        ...
        if default_value:
            ...
            assert (
                obj['fromVersion']
                == load(TEST_VALID_JSON.open())['fromVersion']
            )
    ...
    def test_dump(self):
        ...
        expected_file = (
            Path(TEST_VALID_JSON).parent / f'prefix-{TEST_VALID_JSON.name}'
        )
