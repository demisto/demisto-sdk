...
class ContentPaths:
    ...
    ALL_PACKS_DEPENDENCIES_DEFAULT_PATH: Path = CONTENT_PATH / "all_packs_dependencies.json"
    ...
    def update_content_path(cls, content_path: Union[str, Path]) -> None:
        ...
        cls.ALL_PACKS_DEPENDENCIES_DEFAULT_PATH = cls.CONTENT_PATH / "all_packs_dependencies.json"
        ...
        cls.API_MODULES_SCRIPTS_DIR = cls.CONTENT_PATH / "Packs" / "ApiModules" / "Scripts"
        ...
        if cls.API_MODULES_SCRIPTS_DIR.exists():
            cls.PYTHONPATH.extend(path.absolute() for path in cls.API_MODULES_SCRIPTS_DIR.iterdir())
        else:
            logger.debug(
