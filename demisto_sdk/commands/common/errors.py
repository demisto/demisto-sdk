...
class Errors:
    ...
    @staticmethod
    @error_code_decorator
    def release_notes_docker_image_not_match_yaml(rn_file_name: str, un_matching_files_list: list):
        ...
        for un_matching_file in un_matching_files_list:
            ...
            f"{un_matching_file.get('rn_version')} but the YML file has dockerimage: {un_matching_file.get('yml_version')}\n"
