...
ERROR_CODE = {
    ...
    "cli_name_and_id_are_not_matches": {'code': "BA116", 'ui_applicable': False, 'related_field': 'cliName'},
...
class Errors:
    ...
    @staticmethod
    @error_code_decorator
    def cli_name_and_id_are_not_matches(cli_name_correct):
        return "`cliName` and `id` are not matches\n" \
               "Please fix it so that it is matches except the prefix\n" \
               f"HINT -> cliName: `{cli_name_correct}`"
