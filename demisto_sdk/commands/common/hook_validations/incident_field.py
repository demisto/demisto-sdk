...
class IncidentFieldValidator(FieldBaseValidator):
    ...
    INCIDENT_PROHIBITED_CLI_NAMES = {'id', 'shardid', 'modified', 'autime', 'account', 'type', 'rawtype', 'phase',
                                     'rawphase', 'name', 'rawname', 'status', 'reason', 'created', 'parent', 'occurred',
                                     'duedate', 'reminder', 'closed', 'sla', 'level', 'investigationid', 'details',
                                     'openduration', 'droppedcount', 'linkedcount', 'closinguserId', 'activatinguserId',
                                     'owner', 'roles', 'previousroles', 'hasrole', 'dbotcreatedBy', 'activated',
                                     'closereason', 'rawClosereason', 'playbookid', 'isplayground', 'category',
                                     'rawcategory', 'runstatus', 'rawjson', 'sourcebrand', 'sourceinstance', 'Lastopen',
                                     'canvases', 'notifytime', 'todotaskids', 'scheduled', 'labels'}
    EVIDENCE_PROHIBITED_CLI_NAMES = {'id', 'shardid', 'modified', 'incidentid', 'entryid', 'description', 'tags',
                                     'tagsraw', 'occurred', 'markeddate', 'fetched', 'taskid', 'markedby', 'roles',
                                     'previousroles', 'hasrole', 'dbotcreatedBy',
                                     }
    EVIDENCE_GROUP_ID = 1
