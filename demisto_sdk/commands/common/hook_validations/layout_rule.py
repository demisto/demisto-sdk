...
class LayoutRuleValidator(ContentEntityValidator):
    ...
    def are_all_fields_exist(self):
        ...
        """
        fields_to_check = ("rule_id", "layout_id", "description", "layout_rule_name", "alerts_filter")
        missing_fields = []
        ...
        if missing_fields:
            error_message, error_code = Errors.layout_rule_keys_are_missing(missing_fields)
