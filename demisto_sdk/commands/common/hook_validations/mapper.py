...
class MapperValidator(ContentEntityValidator):
    ...
    def is_incident_field_exist(self) -> bool:
        ...
        content_all_indicator_fields = id_set.get('IncidentFields')
        ...
        all_valid_fields = content_indicator_fields + content_incident_fields + BUILT_IN_FIELDS + LAYOUT_BUILT_IN_FIELDS
