...
class WizardValidator(ContentEntityValidator):
    ...
    def are_dependency_packs_valid(self, id_set_file: Optional[dict]):
        if not id_set_file:
            click.secho("Skipping wizard dependency pack validation. Could not read id_set.json.", fg="yellow")
            return True
    ...
    def are_integrations_in_dependency_packs(self, id_set_file: Optional[dict]):
        if not id_set_file:
            click.secho("Skipping wizard integrations validation. Could not read id_set.json.", fg="yellow")
            return True
    ...
    def are_playbooks_in_dependency_packs(self, id_set_file: Optional[dict]):
        if not id_set_file:
            click.secho("Skipping wizard playbooks validation. Could not read id_set.json.", fg="yellow")
            return True
