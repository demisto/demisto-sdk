...
from demisto_sdk.commands.common.constants import (
    ...
    PACKS_INTEGRATION_YML_REGEX, PACKS_LAYOUTS_REGEX, PACKS_PACKAGE_META_REGEX,
    PACKS_PLAYBOOK_YML_REGEX, PACKS_SCRIPT_JS_REGEX, PACKS_SCRIPT_PY_REGEX,
...
def test_integration_code_files():
    ...
    ) = get_test_code_file_paths(INTEGRATIONS_DIR)
...
def test_script_code_files():
    ...
    ) = get_test_code_file_paths(SCRIPTS_DIR)
...
def get_test_yml_file_paths(folder, prefix, legacy_only=False):
    ...
    return (
        acceptable_yml_files_package.union(acceptable_yml_files_legacy),
...
def test_beta_script_yml_files():
    acceptable_integration_yml, unacceptable_integration_yml = get_test_yml_file_paths(
        BETA_INTEGRATIONS_DIR, "script", legacy_only=True
    )

    verify(
        acceptable_integration_yml, unacceptable_integration_yml, (BETA_SCRIPT_REGEX,),
    )


def test_beta_integration_yml_files():
    acceptable_integration_yml, unacceptable_integration_yml = get_test_yml_file_paths(
        BETA_INTEGRATIONS_DIR, "integration",
    )
...
test_packs_regex_params = [
    ...
    (
        ...
        ["Packs/Sade/Scripts/lo_yarden.py"],
    ...
    (
        ...
        ["Packs/Sade/Classifiers/yarden-json.txt"],
    ...
    (
        ...
        ["Packs/Sade/Dashboards/yarden-json.txt"],
        [PACKS_PACKAGE_META_REGEX],
    ),
    (
        ["Packs/XDR/CHANGELOG.md"],
        ["Packs/Integrations/XDR/CHANGELOG.md"],
