...
from demisto_sdk.commands.common.constants import (
    INCIDENT_TYPE_REGEX, INDICATOR_FIELDS_REGEX, INTEGRATION_JS_REGEX,
    INTEGRATION_PY_REGEX, INTEGRATION_REGEX, INTEGRATION_TEST_PY_REGEX,
    INTEGRATION_YML_REGEX, INTEGRATIONS_DIR, PACKAGE_YML_FILE_REGEX,
    PACKS_CHANGELOG_REGEX, PACKS_CLASSIFIERS_REGEX, PACKS_DASHBOARDS_REGEX,
    PACKS_INCIDENT_FIELDS_REGEX, PACKS_INCIDENT_TYPES_REGEX,
    PACKS_INTEGRATION_JS_REGEX, PACKS_INTEGRATION_PY_REGEX,
    ...
    PACKS_SCRIPT_JS_REGEX, PACKS_SCRIPT_PY_REGEX, PACKS_SCRIPT_TEST_PY_REGEX,
    PACKS_SCRIPT_YML_REGEX, PACKS_TEST_PLAYBOOKS_REGEX, PACKS_WIDGETS_REGEX,
    SCRIPT_JS_REGEX, SCRIPT_PY_REGEX, SCRIPT_REGEX, SCRIPT_TEST_PY_REGEX,
    SCRIPT_YML_REGEX, SCRIPTS_DIR)
