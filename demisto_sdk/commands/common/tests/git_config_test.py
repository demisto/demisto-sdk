...
class TestGitContentConfig:
    ...
    def test_search_gitlab_id_valid(self, mocker, requests_mock):
        ...
        assert git_config.base_api == GitContentConfig.BASE_RAW_GITLAB_LINK.format(GITLAB_HOST=host, GITLAB_ID=3606)
    ...
    def test_provide_repo_name(self, mocker, requests_mock):
        ...
        mocker.patch.object(GitContentConfig, "_search_gitlab_repo", return_value=("gitlab.com", 3))
