...
def test_validness_in_set():
    ...
    assert validator.is_valid_in_id_set(
        file_path="test", obj_data=obj_data, obj_set=obj_set
...
def test_obj_data_mismatch_in_set():
    ...
    obj_data = {"test": {"name": "test"}}
    actual_obj_set = {"test": {"name": "not test", }}
    obj_set = [
        actual_obj_set,
    ]
...
def test_duplicated_id_same_set():
    ...
    assert (
        validator.is_id_duplicated(
            obj_id="test", obj_data=obj_data, obj_type="testing_set"
        )
        is False
...
def test_duplicated_id_different_set():
    ...
    validator.id_set = {"not_testing_set": obj_set}
    assert validator.is_id_duplicated(
        obj_id="test", obj_data=obj_data, obj_type="testing_set"
