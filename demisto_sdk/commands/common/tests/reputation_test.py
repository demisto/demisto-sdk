...
class TestReputationValidator:
    ...
    def test_is_valid_expiration(self, expiration, is_valid):
        structure = StructureValidator("")
    ...
    def test_is_id_equals_name(self, id_, name, is_valid):
        structure = StructureValidator("")
        structure.current_file = {"fromVersion": "5.5.0", "id": id_, "name": name}
        validator = ReputationValidator(structure)
