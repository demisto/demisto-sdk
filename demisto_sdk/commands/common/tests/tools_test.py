...
from demisto_sdk.commands.common.tools import collect_all_inputs_in_use, collect_all_inputs_from_inputs_section
...
def test_collect_all_inputs_in_use_empty(mocker, playbook):
    """
    Given:
...
def test_collect_all_inputs_in_use_with_usage(mocker, playbook):
    ...
    """
    #mocker.patch.object(playbook, 'content_item_as_text', return_value='text {{input1}} more text {{input2}}')
...
def test_collect_all_inputs_from_inputs_section(playbook):
    ...
    Then: 
        - A set with input1 and input2 should be returned
    """
    assert collect_all_inputs_from_inputs_section(playbook) == {'input1', 'input2'}