...
MOCKED_DATA = [
    ...
    (
        [
            ...
            {"Test3": {"name": "Test3", "file_path": "D", "fromversion": "4.5.0", }, },
        ],
        "Test3",
        True,
    ),
...
INTEGRATION_DATA = {
    "Dummy Integration": {
        ...
        "file_path": TESTS_DIR
        + "/test_files/DummyPack/Integrations/DummyIntegration.yml",
        "fromversion": "4.1.0",
        "commands": [
            "xdr-get-incidents",
...
PLAYBOOK_DATA = {
    ...
    "fromversion": "4.5.0",
    "implementing_scripts": ["XDRSyncScript", "StopScheduledTask", ],
...
class TestIntegration(unittest.TestCase):
    def test_get_integration_data(self):
        ...
        file_path = (
            TESTS_DIR + "/test_files/DummyPack/Integrations/DummyIntegration.yml"
        )
    ...
    def test_get_playbook_data(self):
        ...
        self.assertSetEqual(
            set(data["implementing_playbooks"]),
