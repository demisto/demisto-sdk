...
def get_remote_file_from_api(
    ...
    """
    logger.debug(f'get_remote_file_from_api {full_file_path=} | {git_content_config.__dict__ if isinstance(git_content_config, dict) else None} | {tag=} | {return_content=} | {encoding=}')
