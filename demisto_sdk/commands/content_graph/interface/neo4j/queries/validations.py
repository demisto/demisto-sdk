...
AND not all(elem IN content_item_from.marketplaces WHERE elem IN n.marketplaces AND not elem.is_test)
"""
    if pack_ids:
...
AND all(elem IN content_item_from.marketplaces WHERE elem IN n2.marketplaces AND not elem.is_test)
