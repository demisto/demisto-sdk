...
from demisto_sdk.commands.common.constants import KNOWLEDGE_DIR
from demisto_sdk.commands.content_graph.common import ContentType
from demisto_sdk.commands.content_graph.objects.content_item import ContentItem


class Knowledge(ContentItem, content_type=ContentType.KNOWLEDGE):  # type: ignore[call-arg]
    version: int = -1

    @staticmethod
    def match(_dict: dict, path: Path) -> bool:
        if (
            KNOWLEDGE_DIR in path.parts
