...
class AgentixAction(AgentixBase):
    ...
    def validate_script_action_constraints(cls, values):
        ...
        if has_underlying and has_script:
            raise ValueError(
                "Cannot provide both 'underlyingcontentitem' and 'script' at the same time. "
                "Script actions auto-generate 'underlyingcontentitem' at prepare-content time."
            )
        return values
