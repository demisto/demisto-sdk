...
CUSTOM_CONTENT_INTEGRATION_PATH = (
    f"{CUSTOM_CONTENT_BASE_PATH}/integration-Test_Integration.yml"
)
CUSTOM_CONTENT_LAYOUT_PATH = (
    f"{CUSTOM_CONTENT_BASE_PATH}/layout-details-TestLayout.json"
)
CUSTOM_CONTENT_PLAYBOOK_PATH = f"{CUSTOM_CONTENT_BASE_PATH}/playbook-TestPlaybook.yml"

INTEGRATION_PACK_OBJECT = {
    "Test Integration": [
        {
            "name": "Test Integration",
            "id": "Test Integration",
            "path": f"{INTEGRATION_INSTANCE_PATH}/TestIntegration.py",
            "file_ending": "py",
        },
        {
            "name": "Test Integration",
            "id": "Test Integration",
            "path": f"{INTEGRATION_INSTANCE_PATH}/TestIntegration_testt.py",
            "file_ending": "py",
        },
        {
            "name": "Test Integration",
            "id": "Test Integration",
            "path": f"{INTEGRATION_INSTANCE_PATH}/TestIntegration.yml",
            "file_ending": "yml",
        },
        {
            "name": "Test Integration",
            "id": "Test Integration",
            "path": f"{INTEGRATION_INSTANCE_PATH}/TestIntegration_image.png",
            "file_ending": "png",
        },
        {
            "name": "Test Integration",
            "id": "Test Integration",
            "path": f"{INTEGRATION_INSTANCE_PATH}/CHANGELOG.md",
            "file_ending": "md",
        },
        {
            "name": "Test Integration",
            "id": "Test Integration",
            "path": f"{INTEGRATION_INSTANCE_PATH}/TestIntegration_description.md",
            "file_ending": "md",
        },
        {
            "name": "Test Integration",
            "id": "Test Integration",
            "path": f"{INTEGRATION_INSTANCE_PATH}/README.md",
            "file_ending": "md",
        },
    ]
}
    ...
    "TestScript": [
        {
            "name": "TestScript",
            "id": "TestScript",
            "path": f"{SCRIPT_INSTANCE_PATH}/TestScript.py",
            "file_ending": "py",
        },
        {
            "name": "TestScript",
            "id": "TestScript",
            "path": f"{SCRIPT_INSTANCE_PATH}/TestScript.yml",
            "file_ending": "yml",
        },
        {
            "name": "TestScript",
            "id": "TestScript",
            "path": f"{SCRIPT_INSTANCE_PATH}/CHANGELOG.md",
            "file_ending": "md",
        },
        {
            "name": "TestScript",
            "id": "TestScript",
            "path": f"{SCRIPT_INSTANCE_PATH}/README.md",
            "file_ending": "md",
        },
    ]
}
PLAYBOOK_PACK_OBJECT = {
    "FormattingPerformance - Test": [
        {
            "name": "FormattingPerformance - Test",
            "id": "FormattingPerformance - Test",
            "path": PLAYBOOK_INSTANCE_PATH,
            "file_ending": "yml",
        }
    ]
}
...
INTEGRATION_CUSTOM_CONTENT_OBJECT = {
    "id": "Test Integration",
    "name": "Test Integration",
    "path": CUSTOM_CONTENT_INTEGRATION_PATH,
    "entity": "Integrations",
    "type": "integration",
    "file_ending": "yml",
}
SCRIPT_CUSTOM_CONTENT_OBJECT = {
    "id": "TestScript",
    "name": "TestScript",
    "path": CUSTOM_CONTENT_SCRIPT_PATH,
    "entity": "Scripts",
    "type": "script",
    "file_ending": "yml",
}
PLAYBOOK_CUSTOM_CONTENT_OBJECT = {
    "id": "FormattingPerformance - Test",
    "name": "FormattingPerformance - Test",
    "path": CUSTOM_CONTENT_PLAYBOOK_PATH,
    "entity": "Playbooks",
    "type": "playbook",
    "file_ending": "yml",
}
LAYOUT_CUSTOM_CONTENT_OBJECT = {
    "id": "Hello World Alert",
    "name": "Hello World Alert",
    "path": CUSTOM_CONTENT_LAYOUT_PATH,
    "entity": "Layouts",
    "type": "layout",
    "file_ending": "json",
}
FAKE_CUSTOM_CONTENT_OBJECT = {
    "id": "DEMISTO",
    "name": "DEMISTO",
    "path": f"{CUSTOM_CONTENT_BASE_PATH}/DEMISTO.json",
    "entity": "Layouts",
    "type": "layout",
    "file_ending": "json",
}
...
class EnvironmentGuardian:
    ...
    def restore_environment(self, test_name, *args):
        if test_name == "test_update_pack_hierarchy":
            ...
            "test_merge_existing_file",
            "test_merge_and_extract_existing_file",
            "test_update_data_yml",
    ...
    def test_update_pack_hierarchy_env_restore(
        self, integration_instance_temp_path, script_dir_temp_path, script_dir_path
    ):
    ...
    def test_existing_file_env_restore(self):
        shutil.rmtree(
            "demisto_sdk/commands/download/tests/tests_data", ignore_errors=True
        )
        shutil.rmtree(
            "demisto_sdk/commands/download/tests/tests_env", ignore_errors=True
        )
        shutil.copytree(
            src="demisto_sdk/commands/download/tests_backup/tests_data",
            dst="demisto_sdk/commands/download/tests/tests_data",
        )
        shutil.copytree(
            src="demisto_sdk/commands/download/tests_backup/tests_env",
...
class TestHelperMethods:
    ...
    @pytest.mark.parametrize(
        "name, output", [("automation-demisto", "script-demisto"), ("wow", "wow")]
    )
...
class TestBuildPackContent:
    ...
    @pytest.mark.parametrize(
        "entity, path, output_pack_content_object",
        [
    ...
    @pytest.mark.parametrize(
        "entity, path, main_id, main_name",
        [
            (
                INTEGRATIONS_DIR,
                INTEGRATION_INSTANCE_PATH,
                "Test Integration",
                "Test Integration",
            ),
            (
...
class TestBuildCustomContent:
    @pytest.mark.parametrize(
        "custom_content_object, exist_in_pack",
        [
    ...
    def test_exist_in_pack_content(self, custom_content_object, exist_in_pack):
        ...
        with patch.object(Downloader, "__init__", lambda a, b, c: None):
            ...
            assert (
                downloader.exist_in_pack_content(custom_content_object) is exist_in_pack
            )

    @pytest.mark.parametrize(
        "path, output_custom_content_object",
        [
    ...
    def test_build_custom_content_object(self, path, output_custom_content_object):
        downloader = Downloader(output="", input="")
        assert (
            downloader.build_custom_content_object(path) == output_custom_content_object
        )
...
class TestPackHierarchy:
    def test_update_pack_hierarchy(self):
        ...
        (
            integration_instance_temp_path,
            script_dir_temp_path,
            script_dir_path,
...
class TestMergeExistingFile:
    def test_merge_and_extract_existing_file(self):
        ...
        with patch.object(Downloader, "__init__", lambda a, b, c: None):
            ...
            paths = [
                file["path"] for file in INTEGRATION_PACK_OBJECT["Test Integration"]
            ]
            for path in paths:
                ...
                for path_part in dotted_path_list:
                    if path_part != dotted_path_list[-1]:
                        ...
                        if obj.get(path_part):
                            ...
                            test_answer = False
            with open(
                INTEGRATION_PACK_OBJECT["Test Integration"][5]["path"], "r"
            ) as description_file:
                description_data = description_file.read()
            test_answer = (
                test_answer
                and "Test Integration Long Description TEST" in description_data
            )
            with open(
                INTEGRATION_PACK_OBJECT["Test Integration"][0]["path"], "r"
            ) as code_file:
    ...
    @pytest.mark.parametrize(
        "custom_content_object, ending, method, instance_path, fields",
        [
            (
                PLAYBOOK_CUSTOM_CONTENT_OBJECT,
                "yml",
    ...
    def test_merge_existing_file(
        self, custom_content_object, ending, method, instance_path, fields
    ):
        env_guard = EnvironmentGuardian()
        test_answer = True
    ...
    @pytest.mark.parametrize(
        "custom_content_object, pack_content_object",
        [
    ...
    def test_get_corresponding_pack_content_object(
        self, custom_content_object, pack_content_object
    ):
        assert EnvironmentGuardian.verify_environment()
        with patch.object(Downloader, "__init__", lambda a, b, c: None):
            downloader = Downloader("", "")
    ...
    @pytest.mark.parametrize(
        "file_name, ex_file_ending, ex_file_detail, corr_pack_object, pack_file_object",
        [
            (
                "Test Integration",
                "yml",
                "yaml",
                INTEGRATION_PACK_OBJECT,
                INTEGRATION_PACK_OBJECT["Test Integration"][2],
            ),
            (
                "Test Integration",
                "py",
                "python",
                INTEGRATION_PACK_OBJECT,
                INTEGRATION_PACK_OBJECT["Test Integration"][0],
            ),
            (
                "Test Integration",
                "png",
                "image",
                INTEGRATION_PACK_OBJECT,
                INTEGRATION_PACK_OBJECT["Test Integration"][3],
            ),
            (
                "Test Integration",
                "md",
                "description",
                INTEGRATION_PACK_OBJECT,
                INTEGRATION_PACK_OBJECT["Test Integration"][5],
            ),
            (
                "TestScript",
                "yml",
                "yaml",
                SCRIPT_PACK_OBJECT,
                SCRIPT_PACK_OBJECT["TestScript"][1],
            ),
            (
                "TestScript",
                "py",
                "python",
                SCRIPT_PACK_OBJECT,
                SCRIPT_PACK_OBJECT["TestScript"][0],
            ),
            ("Fake Name", "py", "python", SCRIPT_PACK_OBJECT, {}),
        ],
    )
    def test_get_corresponding_pack_file_object(
        self,
        file_name,
        ex_file_ending,
        ex_file_detail,
    ...
    def test_update_data_yml(self):
        ...
        downloader.update_data(
            CUSTOM_CONTENT_INTEGRATION_PATH,
            f"{INTEGRATION_INSTANCE_PATH}/TestIntegration.yml",
            "yml",
        )
        test_answer = True
...
class TestMergeNewFile:
    @pytest.mark.parametrize(
        "custom_content_object, raw_files",
        [
            (
                INTEGRATION_CUSTOM_CONTENT_OBJECT,
                [
            ...
            (
                SCRIPT_CUSTOM_CONTENT_OBJECT,
                ["odp/bn.py", "odp/bn.yml", "odp/README.md", "odp/CHANGELOG.md"],
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "custom_content_object",
        [PLAYBOOK_CUSTOM_CONTENT_OBJECT, LAYOUT_CUSTOM_CONTENT_OBJECT],
    )
    def test_merge_new_file(self, custom_content_object):
        ...
        env_guard.restore_environment(
            "test_merge_new_file", temp_dir, new_file_path, old_file_path
        )
        assert test_answer
