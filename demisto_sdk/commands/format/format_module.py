...
def format_manager(input: str = None, output: str = None, from_version: str = '', no_validate: bool = False, update_docker: bool = False):
    """
        ...
        for file in files:
            ...
            if file_type and file_type.value not in UNFORMATTED_FILES:
                ...
                info_res, err_res, skip_res = run_format_on_file(input=file_path, file_type=file_type,
                                                                 ...
                                                                 no_validate=no_validate, update_docker=update_docker)
                if err_res:
