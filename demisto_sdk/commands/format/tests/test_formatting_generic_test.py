...
class TestFormattingFromVersionKey:
    ...
    def test_update_fromVersion_from_flag(self, mocker):
        ...
        assert (
            base_update.data.get(base_update.from_version_key) == VERSION_6_0_0
        )
    ...
    @pytest.mark.parametrize(
        argnames='content_type', argvalues=special_content_items
    )
...
@pytest.mark.parametrize(
    ...
    [
        (False, 'run_validation_on_specific_files'),
