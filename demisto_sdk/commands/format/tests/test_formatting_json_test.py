...
from demisto_sdk.tests.constants_test import (
    ...
    DESTINATION_FORMAT_PRE_PROCESS_RULES_COPY, DESTINATION_FORMAT_PRE_PROCESS_RULES_INVALID_NAME_COPY,
    ...
    PRE_PROCESS_RULES_PATH, PRE_PROCESS_RULES_SCHEMA_PATH, MAPPER_PATH,
    ...
    SOURCE_FORMAT_LAYOUTS_CONTAINER_COPY, SOURCE_FORMAT_PRE_PROCESS_RULES_COPY, SOURCE_FORMAT_MAPPER,
