...
def test_yml_run_format_exception_handling_2(format_object, mocker, caplog):
    """
    Given
    ...
    mocker.patch.object(BaseUpdateYML, "update_yml", side_effect=exception_raise)
    mocker.patch.object(PlaybookYMLFormat, "update_tests", side_effect=exception_raise)
