...
def get_command_examples(commands_examples_input, specific_commands):
    ...
    logger.info(f"<yellow>Readable: {os.access(commands_examples_input, os.R_OK)}</yellow>")
    logger.info(f"<yellow>Writable: {os.access(commands_examples_input, os.W_OK)}</yellow>")
    logger.info(f"<yellow>Executable: {os.access(commands_examples_input, os.X_OK)}</yellow>")
