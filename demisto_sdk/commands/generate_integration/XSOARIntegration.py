...
class XSOARIntegration:
    ...
    def get_base_integration(cls):
        ...
        configurations = [
            XSOARIntegration.Configuration(display="Fetch incidents", name="isFetch", type_=8, required=False),
            XSOARIntegration.Configuration(display="Incident type", name="incidentType", type_=13, required=False),
            ...
            XSOARIntegration.Configuration(display="API Key", name="apikey", type_=4, required=True),
            XSOARIntegration.Configuration(
        ...
        return cls(commonfields, name, display, category, description, configurations, script)
