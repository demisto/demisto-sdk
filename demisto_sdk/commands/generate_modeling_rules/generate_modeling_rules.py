...
def generate_modeling_rules(
    ...
    raw_event_path: Path = typer.Argument(
        ...
        show_default=False,
        help=(
            "The path to a raw event from the api call in a json format."
        ),
    ),
...
def create_xif_file(mapping_list: List[MappingField], outputfile_xif: Path, dataset_name: str) -> None:
    """
...
def create_scheme_file(mapping_list: List[MappingField], dataset_name, outputfile_schema):
    """
