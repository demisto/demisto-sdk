...
*  **-di, --docker-image**
    The docker image to check package on. Possible values: 'naive:maintenance', 'naive:ga', 'native:dev', 'all', a specific docker image from Docker Hub (e.g devdemisto/python3:3.10.9.12345) or the default 'from-yml'.
