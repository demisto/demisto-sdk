...
def test_validate_env(mocker) -> None:
    ...
    helpers.run_command_os.side_effect = [
        ("python2", "", ""),
        ("flake8, mypy, vultue", "", ""),
    ]
...
@pytest.mark.parametrize(
    argnames="no_flake8, no_bandit, no_mypy, no_pylint, no_vulture, no_test, no_pwsh_analyze, "
    "no_pwsh_test, docker_engine, expected_value",
    argvalues=[
        (True, True, True, True, True, True, True, True, True, 0b11111111),
