...
class TestPostmanHelpers:
    ...
    shared_args_path_items = get_json(json_file)
    ...
    SHARED_ARGS_PATH = (
        (shared_args_path_items["many_with_shared_paths"], many_with_shared_paths),
        (
...
class TestPostmanCodeGen:
    ...
    def setup_class(cls):
        ...
        cls.postman_collection = get_json(collection_path)
            ...
            with_request={
                ...
                "request": {
                    ...
                    "url": {
                        ...
                        "host": ["{{url}}"],
                        "path": ["vtapi", "v2", ":Virus_name", "test", "{{foo}}"],
...
def _testutil_create_postman_collection(
    ...
    collection = get_json(default_collection_path)
