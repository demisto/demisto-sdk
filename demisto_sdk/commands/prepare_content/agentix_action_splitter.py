...
class AgentixActionSplitter:
    ...
    def generate_script_dict(action: "AgentixAction", py_code: str) -> dict:
        ...
        # standalone is the sole source of truth for the generated script's visibility:
        #   standalone=None or False → script is internal (hidden, default)
        #   standalone=True → script is NOT internal (visible in UI)
        # action.internal does NOT propagate to the script — it only affects the action itself.
