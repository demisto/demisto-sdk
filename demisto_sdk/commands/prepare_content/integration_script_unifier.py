...
class IntegrationScriptUnifier(Unifier):
        ...
        **kwargs,
        ...
        if not is_script_package:
            ...
            if IntegrationScriptUnifier.is_contributor_pack(contributor_type):
                ...
                yml_unified = IntegrationScriptUnifier.add_contributors_support(yml_unified, contributor_type, contributor_email,
    ...
    def get_contributor_data(package_path: Path, is_script_package: bool = False):
        ...
        pack_metadata_data, pack_metadata_path = IntegrationScriptUnifier.get_data(pack_path, PACK_METADATA_PATH, is_script_package)
    ...
    @staticmethod
    def add_contributors_support(unified_yml: Dict, contributor_type: str,
