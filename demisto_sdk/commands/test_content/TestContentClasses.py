...
class TestPlaybook:
    ...
    def should_test_run(self):
        ...
        logging.info(f'Build context class name: {type(self.build_context).__name__}')
        logging.info(f'is_performance_test exists: {hasattr(self.build_context, "is_performance_test")}')
