...
class AMIConnection:
    ...
    def add_ssh_prefix(self, command, ssh_options=""):
        ...
        prefix = "ssh {} {}@{}".format(ssh_options, self.REMOTE_MACHINE_USER, self.internal_ip).split()
    ...
    def copy_file(self, src, dst=REMOTE_HOME, **kwargs):
        silence_output(check_call, ['scp', src, "{}@{}:{}".format(self.REMOTE_MACHINE_USER, self.internal_ip, dst)],
                       stdout='null', **kwargs)
