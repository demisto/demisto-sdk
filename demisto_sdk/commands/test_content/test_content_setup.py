...
def test_content(
        ...
        artifacts_bucket: str = typer.Option(None, help="The artifacts bucket name to upload the results to"),
        ...
        server_version: str = typer.Option("NonAMI",
        ...
        server_type: str = typer.Option("XSOAR", help="On which server type runs the tests: XSIAM, XSOAR, XSOAR SAAS"),
        product_type: str = typer.Option("XSOAR", help="On which product type runs the tests: XSIAM, XSOAR"),
        cloud_machine_ids: str = typer.Option(None, help="Cloud machine ids to use."),
        cloud_servers_path: str = typer.Option(None, help="Path to secret cloud server metadata file."),
        cloud_servers_api_keys: str = typer.Option(None, help="Path to file with cloud Servers API keys."),
        machine_assignment: str = typer.Option("./machine_assignment.json",
