...
def update_server_configuration(client, server_configuration, error_msg, logging_manager=None, configs_to_delete=None):
    ...
    Args:
        ...
        configs_to_delete (set): The server configuration to be deleted
