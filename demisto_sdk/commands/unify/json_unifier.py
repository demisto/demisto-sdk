...
class YAMLUnifier(ABC):
    ...
    def _prepare_for_marketplace(self):
        if self.marketplace in {MarketplaceVersions.MarketplaceV2, MarketplaceVersions.XPANSE}
            self._alternate_item_fields(self.yml_data)
    ...
    def _prepare_yml(self):
        self._prepare_for_marketplace()
