...
class XDRCTemplateUnifier:
    def __init__(
        ...
        _, self.yml_path = get_yml_paths_in_dir(
    ...
    def unify(self):
        ...
        click.secho(
            f"Successfully created unified JSON in {self.dest_path}", fg="green"
        )
    ...
    def _set_dest_path(
        ...
        output_filename = "{}-{}-{}.json".format(
            "external", DIR_TO_PREFIX[self.dir_name], package_dir_name
        )
