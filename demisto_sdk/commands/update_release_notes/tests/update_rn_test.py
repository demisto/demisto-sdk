...
class TestRNUpdate(unittest.TestCase):
    ...
    def test_build_rn_template_integration(self):
        ...
        update_rn = UpdateRN(
            pack="HelloWorld", update_type="minor", pack_files={"HelloWorld"}
        )
        changed_items = {
    ...
    def test_bump_version_number_major(self):
        ...
        update_rn = UpdateRN(
            pack="HelloWorld", update_type="major", pack_files={"HelloWorld"}
        )
        update_rn.metadata_path = os.path.join(
            TestRNUpdate.FILES_PATH, "fake_pack/pack_metadata.json"
        )
    ...
    def test_bump_version_number_revision(self):
        ...
        update_rn = UpdateRN(
            pack="HelloWorld", update_type="revision", pack_files={"HelloWorld"}
        )
        update_rn.metadata_path = os.path.join(
            TestRNUpdate.FILES_PATH, "fake_pack/pack_metadata.json"
        )
...
class TestRNUpdateUnit:
    ...
    def test_ident_changed_file_type_integration(self, mocker):
        ...
        update_rn = UpdateRN(
            pack="VulnDB", update_type="minor", pack_files={"HelloWorld"}
        )
    ...
    def test_ident_changed_file_type_playbooks(self, mocker):
        ...
        filepath = os.path.join(
            TestRNUpdate.FILES_PATH, "Playbooks/VulnDB/VulnDB_playbook.yml"
        )
        mocker.patch.object(
            UpdateRN,
            "find_corresponding_yml",
    ...
    def test_ident_changed_file_type_incident_fields(self, mocker):
        ...
        filepath = os.path.join(
            TestRNUpdate.FILES_PATH, "IncidentFields/VulnDB/VulnDB.json"
        )
        mocker.patch.object(
            UpdateRN,
            "find_corresponding_yml",
    ...
    def test_ident_changed_file_type_incident_types(self, mocker):
        ...
        filepath = os.path.join(
            TestRNUpdate.FILES_PATH, "IncidentTypes/VulnDB/VulnDB.json"
        )
        mocker.patch.object(
            UpdateRN,
            "find_corresponding_yml",
    ...
    def test_ident_changed_file_type_classifiers(self, mocker):
        ...
        filepath = os.path.join(
            TestRNUpdate.FILES_PATH, "Classifiers/VulnDB/VulnDB.json"
        )
        mocker.patch.object(
            UpdateRN,
            "find_corresponding_yml",
