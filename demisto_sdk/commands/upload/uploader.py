...
class Uploader:
    ...
    def directory_uploader(self, path: str):
        ...
        elif is_path_of_playbook_directory(path) or is_path_of_test_playbook_directory(
            path
        ):
    ...
    def integration_uploader(self, path: str):
        ...
        try:
            ...
            print_color(
                f"Uploaded integration - '{file_name}': successfully", LOG_COLORS.GREEN
            )
        ...
        try:
            if os.path.isdir(path):  # Create a temporary unified yml file
                ...
                try:
                    ...
                    print_error(
                        f"Error uploading script from pack. /"
            ...
            print_v(f"Result:\n{result.to_str()}", self.log_verbose)
            print_color(
                f"Uploaded script - '{file_name}': successfully", LOG_COLORS.GREEN
            )
    ...
    def playbook_uploader(self, path: str):
        ...
        try:
            ...
            print_v(f"Result:\n{result.to_str()}", self.log_verbose)
            print_color(
                f"Uploaded playbook - '{file_name}': successfully", LOG_COLORS.GREEN
            )
    ...
    def incident_field_uploader(self, path: str):
        ...
        try:
            ...
            print_v(f"Result:\n{result.to_str()}", self.log_verbose)
            print_color(
                f"Uploaded incident field - '{os.path.basename(path)}': successfully",
                LOG_COLORS.GREEN,
            )
    ...
    def widget_uploader(self, path: str):
        ...
        try:
            ...
            print_v(f"Result:\n{result.to_str()}", self.log_verbose)
            print_color(
                f"Uploaded widget - '{os.path.basename(path)}': successfully",
                LOG_COLORS.GREEN,
            )
    ...
    def dashboard_uploader(self, path: str):
        ...
        try:
            ...
            print_v(f"Result:\n{result.to_str()}", self.log_verbose)
            print_color(
                f"Uploaded dashboard - '{os.path.basename(path)}': successfully",
                LOG_COLORS.GREEN,
            )
    ...
    def layout_uploader(self, path: str):
        ...
        try:
            ...
            print_v(f"Result:\n{result.to_str()}", self.log_verbose)
            print_color(
                f"Uploaded layout - '{os.path.basename(path)}': successfully",
                LOG_COLORS.GREEN,
            )
    ...
    def classifier_uploader(self, path: str):
        ...
        try:
            ...
            print_v(f"Result:\n{result.to_str()}", self.log_verbose)
            print_color(
                f"Uploaded classifier - '{os.path.basename(path)}': successfully",
                LOG_COLORS.GREEN,
            )
    ...
    def _parse_error_response(
        self, error: ApiException, file_type: str, file_name: str
    ):
