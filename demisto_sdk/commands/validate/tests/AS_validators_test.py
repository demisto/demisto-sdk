...
@pytest.mark.parametrize(
    ...
    [
        ...
        # 10. Autonomous pack, single-segment key used as root in another task — valid
        (
            True,
            "autonomous",
            [
                (
                    "1",
                    "Suspicious lines: ${SuspiciousCommandLines}.",
                    None,
                ),
                (
                    "2",
        ...
        # 11. Autonomous pack, displayLabel ${File.SHA256} with File used as root in another task — valid
        (
            True,
            "autonomous",
            [
        ...
        # 12. Autonomous pack, displayLabel ${File.SHA256} with File.Extension in another task — valid
        (
            True,
            "autonomous",
            [
                ...
                (
                    "2",
                    None,
                    {"ext": {"simple": "${File.Extension}"}},
                ),
            ],
            0,
        ),
        # 13. Autonomous pack, single-segment key used via iscontext:true simple field — valid
        (
            True,
            "autonomous",
            [
                (
                    "1",
                    "The command lines ${SuspiciousCommandLines} were confirmed.",
                    None,
                ),
                (
                    "2",
        ...
        # 14. Autonomous pack, DT filter in displayLabel key, root used in another task — valid
        (
            True,
            "autonomous",
            [
                (
                    "1",
                    "TIM score: ${FileEnrichment(val.TIMScore == 0).Value}.",
                    None,
                ),
                (
                    "2",
