    ...
    [
        (
            ...
            ['Pack for a content item /newPackName was changed from pack_170 to newPackName, please undo.',
             ...
             'Pack for a content path /newPackName/CorrelationRules/correlation_rule.yml was changed from pack_173 to newPackName, please undo.',
             'Pack for a content path /newPackName/Playbooks/playbook-0.yml was changed from pack_174 to newPackName, please undo.',
             'Pack for a content path /newPackName/ModelingRules/modelingrule_0/modelingrule_0.yml was changed from pack_175 to newPackName, please undo.',
             'Pack for a content path /newPackName/Integrations/integration_0/integration_0.yml was changed from pack_176 to newPackName, please undo.',
