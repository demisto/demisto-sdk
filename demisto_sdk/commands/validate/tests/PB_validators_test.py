...
@pytest.mark.parametrize(
    ...
    [
        ...
        (create_playbook_object(paths=['inputs', 'tasks'],values=[[{"key":"input_name2", "value":"input_value2"}], {'key':{"first_input":"inputs.input_name1"}}]),"The playbook 'Detonate File - JoeSecurity V2' contains the following inputs that are not used in any of its tasks: input_name2"),
    ],
)
