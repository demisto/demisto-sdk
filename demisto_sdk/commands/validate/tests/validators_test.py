...
# TODO: need to fix this test with new GIT-SHA location
...
#     assert sha1, 'GIT_SHA1 path in config.yml has been changed. Fix the demisto-sdk or revert changes in content
#     repo.'
