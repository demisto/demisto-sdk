...
from demisto_sdk.tests.constants_test import (
    ...
    INVALID_LAYOUT_PATH, INVALID_NO_HIDDEN_PARAMS,
    INVALID_ONE_LINE_1_CHANGELOG_PATH, INVALID_PLAYBOOK_CONDITION_1,
    ...
    VALID_MD, VALID_MULTI_LINE_LIST_CHANGELOG_PATH, VALID_NO_HIDDEN_PARAMS,
