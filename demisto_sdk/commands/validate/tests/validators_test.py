...
from demisto_sdk.tests.constants_test import (
    ...
    INVALID_LAYOUT_PATH, INVALID_LAYOUT_PATH2, INVALID_LAYOUT_PATH3,
...
class TestValidators:
    ...
    INPUTS_IS_VALID_VERSION = [
        ...
        (INVALID_LAYOUT_PATH2, LAYOUT_TARGET, False, LayoutValidator),
        (INVALID_LAYOUT_PATH3, LAYOUT_TARGET, False, LayoutValidator),
