...
from demisto_sdk.commands.content_graph.objects.agentix_action import AgentixActionArgument
...
class IsActionArgsContainDuplicationsValidator(BaseValidator[ContentTypes]):
    error_code = "AG103"
    ...
    error_message = "The following Agentix action '{0}' contains duplicated arguments:\n{1}\n" \
    ...
    def obtain_invalid_content_items(
        ...
        return [
            ...
            if (
                duplicated_args_by := self.is_containing_dups(
                    content_item.args
                )
            )
        ]
