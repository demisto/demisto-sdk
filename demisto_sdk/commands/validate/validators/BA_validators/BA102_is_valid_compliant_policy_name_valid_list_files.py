...
from demisto_sdk.commands.validate.validators.BA_validators.BA102_is_valid_compliant_policy_name_valid import IsValidCompliantPolicyNameValidator

ContentTypes = Union[Integration, Script]


class IsValidCompliantPolicyNameValidatorListFiles(IsValidCompliantPolicyNameValidator):
