...
class IdChangedValidator(BaseValidator[ContentTypes]):
    ...
    rationale = (
        "Changing the ID of an item causes it to show as a new item in the platform, "
        "and to not update properly for users who already have a previous version installed."
    )
