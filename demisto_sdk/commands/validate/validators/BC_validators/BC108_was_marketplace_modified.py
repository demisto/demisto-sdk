...
class WasMarketplaceModifiedValidator(BaseValidator[ContentTypes]):
    error_code = "BC108"
    description = "Verify that the 'marketplaces' property hasn't been removed or added in a manner that effectively removes all others."
    rationale = "Removing a marketplace or adding a new one that effectively removes all others can cause issues with the content item's visibility and availability."
