...
class IsValidConnectionMetadataValidator(ConnectorsValidator[ContentTypes]):
    ...
    description = (
        ...
        "'Connection', description must equal the standard authorization "
        "prompt, and help must be present."
    )
    rationale = (
        ...
        "and a non-empty help text must guide the user through authorizing "
        "the connection."
    )
    error_message = (
    ...
    def obtain_invalid_content_items(
        ...
        for connector in content_items:
            ...
            if not connection.help or not connection.help.strip():
                details.append("metadata.help must be present and non-empty")
