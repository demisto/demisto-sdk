...
class IsDashboardContainNecessaryFieldsValidator(BaseValidator[ContentTypes]):
    ...
    dashboard_error_message = "The '{0}' fields are missing from {1} and need to be added."
    ...
    def is_valid(self, content_items: Iterable[ContentTypes]) -> List[ValidationResult]:
        ...
        for content_item in content_items:
            error_messages = []
            dashboard_missing_fields = FIELDS_TO_INCLUDE.difference(content_item.data_dict)
