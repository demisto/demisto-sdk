...
class DockerImageIsNotNativeImageValidator(BaseValidator[ContentTypes]):
    ...
    rationale = "The 'native-image' Docker image is intended for internal development and should not be used for running integrations or scripts."  # TODO https://jira-dc.paloaltonetworks.com/browse/CIAC-6556
