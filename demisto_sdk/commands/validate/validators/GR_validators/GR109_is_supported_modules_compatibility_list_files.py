...
from demisto_sdk.commands.content_graph.objects import Job, AgentixAction, AgentixAgent
...
class IsSupportedModulesCompatibilityListFiles(IsSupportedModulesCompatibility):
