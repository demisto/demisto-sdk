...
class IsAgentixActionUsingExistingContentItemValidator(BaseValidator[ContentTypes], ABC):
    ...
    def obtain_invalid_content_items_using_graph(self, content_items: Iterable[ContentTypes],
        ...
        for content_item in content_items:
            ...
            if pack_id in ["_any_", "_builtin_"]:  # no validation when the action wraps a builtin or enrich command
                continue
                ...
                results.append(
                    ValidationResult(
                        ...
                        content_object=content_item,
                                                                    ...
                                                                    pack_id=pack_id, graph_result=graph_result):
                results.append(
                    ValidationResult(
                        validator=self,
    ...
    def is_content_item_related_to_the_right_pack(self, content_item_type: str, pack_id: str,
