...
from demisto_sdk.commands.validate.validators.GR_validators.GR110_is_agentix_action_using_existing_content_item_valid import IsAgentixActionUsingExistingContentItemValidator
...
class IsAgentixActionUsingExistingContentItemValidatorListFiles(IsAgentixActionUsingExistingContentItemValidator):
