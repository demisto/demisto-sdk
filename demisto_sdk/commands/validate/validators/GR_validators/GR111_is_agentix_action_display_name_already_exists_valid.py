...
class IsAgentixActionDisplayNameAlreadyExistsValidator(BaseValidator[ContentTypes], ABC):
    error_code = "GR111"
    ...
    error_message = (
        "Agentix Action '{content_id}' has a duplicate display name as: {duplicate_display_name_ids}."
    )
    ...
    def obtain_invalid_content_items_using_graph(
        ...
        query_results = self.graph.validate_duplicate_agentix_action_display_names(query_list)
