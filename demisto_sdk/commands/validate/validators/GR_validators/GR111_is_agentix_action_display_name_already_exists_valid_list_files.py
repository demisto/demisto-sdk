...
from demisto_sdk.commands.validate.validators.GR_validators.GR111_is_agentix_action_display_name_already_exists_valid import IsAgentixActionDisplayNameAlreadyExistsValidator

ContentTypes = Integration


class IsAgentixActionDisplayNameAlreadyExistsValidatorListFiles(IsAgentixActionDisplayNameAlreadyExistsValidator):
