...
from demisto_sdk.commands.validate.validators.GR_validators.GR112_is_agentix_action_name_already_exists_valid import IsAgentixActionNameAlreadyExistsValidator

ContentTypes = Integration


class IsAgentixActionNameAlreadyExistsValidatorListFiles(IsAgentixActionNameAlreadyExistsValidator):
