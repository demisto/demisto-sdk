...
from demisto_sdk.commands.validate.validators.GR_validators.GR114_is_non_mandatory_supported_modules_compatibility import (
    IsNonMandatorySupportedModulesCompatibility,
)


class IsNonMandatorySupportedModulesCompatibilityListFiles(
    IsNonMandatorySupportedModulesCompatibility
):
