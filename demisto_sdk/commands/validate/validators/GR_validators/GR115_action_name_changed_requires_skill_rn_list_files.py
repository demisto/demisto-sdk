...
from demisto_sdk.commands.validate.validators.GR_validators.GR115_action_name_changed_requires_skill_rn import (
    IsActionNameChangedRequiresSkillRNValidator,
)

ContentTypes = AgentixAction


class IsActionNameChangedRequiresSkillRNValidatorListFiles(
    IsActionNameChangedRequiresSkillRNValidator
):
