...
from demisto_sdk.commands.validate.validators.GR_validators.GR999_is_invalid_packs_dependencies_valid import IsInvalidPacksDependenciesValidator

ContentTypes = Pack


class IsInvalidPacksDependenciesValidatorListFiles(IsInvalidPacksDependenciesValidator):
