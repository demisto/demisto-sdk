...
class IsRepCommandContainIsArrayArgumentValidator(BaseValidator[ContentTypes]):
    ...
    rationale = (
        "Setting 'isArray' to True is crucial for reputation commands. "
        "Without it, multiple inputs can lead to the spawning of a large number of docker containers during enrichment, which can impact performance. "
