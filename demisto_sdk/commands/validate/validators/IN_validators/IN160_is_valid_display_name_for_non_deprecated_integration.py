...
class IsValidDisplayNameForNonDeprecatedIntegrationValidator(BaseValidator[ContentTypes]):
    error_code = "IN158"
    ...
    def is_valid(self, content_items: Iterable[ContentTypes]) -> List[ValidationResult]:
        return [
            ...
            if not content_item.deprecated and content_item.display_name.endswith("(Deprecated)")
        ]
