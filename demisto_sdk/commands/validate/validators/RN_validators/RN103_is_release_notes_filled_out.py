        ...
        return [
            ...
            and (
                ...
                or any(
                    ...
                    for note in ["%%UPDATE_RN%%", "%%XSIAM_VERSION%%", "%%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%",
                        "%%UPDATE_CONTENT_ITEM_DESCRIPTION%%", "%%UPDATE_CONTENT_ITEM_NAME%%", "%%UPDATE_CONTENT_ITEM_TYPE%%"]
                )
            )
        ]
