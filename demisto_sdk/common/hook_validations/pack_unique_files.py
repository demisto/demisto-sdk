...
from demisto_sdk.common.tools import pack_name_to_path
from demisto_sdk.common.constants import PACKS_WHITELIST_FILE_NAME, PACKS_PACK_IGNORE_FILE_NAME,\
...
class PackUniqueFilesValidator():
    ...
    def validate_pack_meta_file(self):
        """Validate everything related to metadata.json file"""
