...
This document describes exactly **what files are written** and **which fields are touched** when the [`manifest_generator.py`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:1) script runs. There are two top-level flows:
...
The CLI entry-point [`generate_manifest()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:848) dispatches based on whether the connector directory already exists:
...
- `mapped_params` — JSON string from [`connector_param_mapper.py`](../../demisto-sdk/demisto_sdk/scripts/connector_param_mapper.py:1), e.g.
  ```json
  {
...
| Var | Source | Example |
|---|---|---|
| `handler_id` | [`derive_handler_id(integration_id)`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:207) | `"xsoar_jira"` |
| `cap_slug` | [`slugify_capability_name(name)`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:220) | `"fetch-issues"` |
...
Entry point: [`create_manifest_from_scratch()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:631)
...
#### 📄 `connector.yaml` — built by [`build_connector_yaml()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:172)

| Field | Value | Source |
|---|---|---|
| `id` | slug from `connector_title` (via [`title_to_slug`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:40)) | derived |
...
#### 📄 `handler.yaml` — built by [`build_handler_yaml()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:239)

Written via [`write_handler_yaml()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:333) which prepends the `# yaml-language-server: $schema=...` directive.
...
#### 📄 `serializer.yaml` — written by [`write_serializer_yaml()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:348)

Stub file — a placeholder string constant `SERIALIZER_PLACEHOLDER`. No structured fields yet.

#### 📄 `summary.yaml` — built by [`build_summary_yaml()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:609)

Written **only on from-scratch**. Not touched on append.

#### 📄 `capabilities.yaml` — built by [`build_capabilities_yaml()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:371)

Written via [`write_capabilities_yaml()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:400) which prepends the schema directive.
...
#### 📄 `configurations.yaml` — built by [`build_configurations_yaml()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:410)
...
Entry point: [`add_handler_to_existing_connector()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:706)
...
For **each capability** in `mapped_params` (excluding `general_configurations`), [`append_capability_to_files()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:508) makes a decision:
...
| # | File | Action |
|---|---|---|
| 1 | `components/handlers/xsoar_existing/handler.yaml` | Rename cap id: `<cap_slug>` → `xsoar_existing-<cap_slug>`. Schema directive + all other fields preserved (via [`rename_handler_capability_id()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:483)). |
...
Handled by [`merge_general_configurations()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:586) **on `capabilities.yaml` only** (per the field group structure):
...
| Field | Action |
|---|---|
| `metadata.tags` | Merged via [`merge_tags_case_insensitive()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:126) — existing wins on case conflict |
| `metadata.version` | Bumped via [`bump_minor_version()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:148) — `X.Y.Z` → `X.(Y+1).0` |
...
| Case 2 raises if 0 or >1 owning handlers | [`find_existing_handler_for_capability()`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:438) | A flat capability should always be owned by exactly one handler — anything else is a structural error |
...
|---|---|---|
| [`build_connector_yaml`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:172) | connector.yaml | from-scratch build |
| [`merge_tags_case_insensitive`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:126) + [`bump_minor_version`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:148) | connector.yaml | append updates |
| [`build_handler_yaml`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:239) + [`write_handler_yaml`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:333) | handler.yaml (new) | both flows; `cap_name_to_handler_cap_id` override only on append |
| [`write_serializer_yaml`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:348) | serializer.yaml (new) | both flows |
| [`build_summary_yaml`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:609) | summary.yaml | from-scratch only |
| [`build_capabilities_yaml`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:371) | capabilities.yaml (new) | from-scratch only |
| [`build_configurations_yaml`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:410) | configurations.yaml (new) | from-scratch only |
| [`merge_general_configurations`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:586) | capabilities.yaml | append; dedup case-sensitive on field id |
| [`append_capability_to_files`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:508) | capabilities.yaml + configurations.yaml + (Case 2 only) existing handler.yaml | append; 3-case decision tree |
| [`find_existing_handler_for_capability`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:438) | reads handler.yaml files | append, Case 2 only; raises on 0 or >1 matches |
| [`rename_handler_capability_id`](../../demisto-sdk/demisto_sdk/scripts/manifest_generator.py:483) | existing handler.yaml | append, Case 2 only; preserves schema directive + all other fields |
