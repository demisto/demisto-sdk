...
TEST_PLAYBOOK = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/playbook-TestPlaybooks.yml'
)
...
VALID_METADATA1_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/1.pack_metadata.json'
)
VALID_METADATA2_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/2.pack_metadata.json'
)
...
VALID_IMAGE_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/integration-test_image.png'
)
...
VALID_PIPEFILE_LOCK_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/Pipfile.lock'
)
VALID_PACK_IGNORE_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/.pack-ignore'
)
VALID_SECRETS_IGNORE_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/.secrets-ignore'
)
VALID_CLASSIFIER_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/classifier.json'
)
...
IGNORED_PNG = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/docs_test/closing_params.png'
)
...
VALID_LAYOUT_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/layout-valid.json'
)
INVALID_LAYOUT_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/layout-invalid.json'
)
...
VALID_WIDGET_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/widget-valid.json'
)
INVALID_WIDGET_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/widget-invalid.json'
)
VALID_DASHBOARD_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/dashboard-valid.json'
)
...
INVALID_SCRIPT_PATH = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/script-invalid.yml'
)
...
VALID_INCIDENT_TYPE_FILE__RAW_DOWNLOADED = f'{GIT_ROOT}/demisto_sdk/tests/test_files/IncidentType__raw_downloaded.json'
VALID_INCIDENT_TYPE_FILE = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/IncidentType.json'
)
...
DESTINATION_FORMAT_INCIDENTFIELD_COPY = (
    'IncidentFields/incidentfield-copy.json'
)
...
DESTINATION_FORMAT_DESCRIPTION_COPY = (
    'Description/formatted_description-test.md'
)
...
DESTINATION_FORMAT_INDICATORFIELD_COPY = (
    'IndicatorFields/incidentfield-copy.json'
)
...
LAYOUT_PATH = 'Layouts'
LAYOUT_SCHEMA_PATH = (
    f'{GIT_ROOT}/demisto_sdk/commands/common/schemas/layout.yml'
)
...
DESTINATION_FORMAT_PRE_PROCESS_RULES_COPY = (
    'PreProcessRules/preprocessrule-copy.json'
)
...
PRE_PROCESS_RULES_SCHEMA_PATH = (
    f'{GIT_ROOT}/demisto_sdk/commands/common/schemas/pre-process-rules.yml'
)
...
DESTINATION_FORMAT_CLASSIFIER_5_9_9 = (
    'Classifiers/formatted_classifier_5_9_9.json'
)
...
SOURCE_FORMAT_MAPPER = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/format_mapper.json'
)
DESTINATION_FORMAT_MAPPER = 'Classifiers/formatted_mapper.json'
MAPPER_SCHEMA_PATH = (
    f'{GIT_ROOT}/demisto_sdk/commands/common/schemas/mapper.yml'
)
...
SOURCE_FORMAT_WIDGET = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/format_widget.json'
)
DESTINATION_FORMAT_WIDGET = 'Widgets/formatted-widget.json'
WIDGET_PATH = 'Widgets'

SOURCE_FORMAT_REPORT = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/format_report.json'
)
DESTINATION_FORMAT_REPORT = 'Reports/formatted-Reports.json'
REPORT_PATH = 'Reports'

SOURCE_FORMAT_PLAYBOOK = (
    f'{GIT_ROOT}/demisto_sdk/tests/test_files/format_playbook.yml'
)
