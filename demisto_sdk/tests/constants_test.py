...
VALID_PLAYBOOK_ARCSIGHT_ADD_DOMAIN_PATH = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/Playbooks." f"playbook-ArcSight_Add_Domain_Indicators.yml"
)
...
INVALID_INTEGRATION_NON_CONFIGURED_TESTS = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/" f"non-valid-integration-test-not-configured.yml"
)
...
VALID_JSON_FILE_FOR_UNIT_TESTING = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/fake_pack/Integrations/" f"test_data/results.json"
)
VALID_DOC_FILES_PATH_FOR_UNIT_TESTING = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/content_slim/Packs/Sample01/" f"doc_files/sample_packs.png"
)
...
INVALID_PLAYBOOK_CONDITION_1 = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/playbook-Invalid_condition_unhandled_" f"branch.yml"
)
...
INVALID_PLAYBOOK_UNHANDLED_CONDITION = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/content_repo_example/Packs/" f"FeedAzure/Playbooks/FeedAzure_test.yml"
)
...
SOURCE_FORMAT_INTEGRATION_DEFAULT_VALUE = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files" f"/format_integration_defaultvalue_test.yml"
)
...
PLAYBOOK_WITH_INCIDENT_INDICATOR_SCRIPTS = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/playbook-with-incidnet-" f"indicator-fields.yml"
)
...
CORRECT_PLAYBOOK_REFERENCE_USE = f"{GIT_ROOT}/demisto_sdk/tests/test_files/correct_playbook_reference_use.yml"
...
INDICATORFIELD_MISSING_AND_EXTRA_FIELDS = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/" f"indicatorfield-missing-and-extra-fields.json"
)
...
SOURCE_DESCRIPTION_FORMATTED_CONTRIB_DETAILS = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/" f"description_formatted_contrib_details.md"
)
SOURCE_DESCRIPTION_WITHOUT_BETA_DESCRIPTION = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/" f"description_without_beta_description-test.md"
)
SOURCE_DESCRIPTION_FORMATTED_WITH_BETA_DESCRIPTION = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/" f"description_formatted_with_beta_description-test.md"
)
...
SOURCE_FORMAT_LAYOUT_COPY = f"{GIT_ROOT}/demisto_sdk/tests/test_files/format_layout-dev.json"
...
XSOAR_LINTER_PY3_INVALID_WARNINGS_PARTNER = (
    f"{GIT_ROOT}/demisto_sdk/tests/test_files/invalid_py3_XSOARLinter_warnings_partner.py"
)

DESTINATION_FORMAT_INTEGRATION = "Integrations/integration.yml"
INTEGRATION_PATH = "Integrations"
INTEGRATION_SCHEMA_PATH = f"{GIT_ROOT}/demisto_sdk/commands/common/schemas/integration.yml"
...
INCIDENTTYPE_SCHEMA_PATH = f"{GIT_ROOT}/demisto_sdk/commands/common/schemas/incidenttype.yml"
INDICATORFIELD_SCHEMA_PATH = f"{GIT_ROOT}/demisto_sdk/commands/common/schemas/indicatorfield.yml"
INDICATORTYPE_SCHEMA_PATH = f"{GIT_ROOT}/demisto_sdk/commands/common/schemas/reputation.yml"
