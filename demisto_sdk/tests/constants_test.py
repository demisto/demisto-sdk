...
SERVER_VALID_INCIDENT_TYPE_FILE = f"{GIT_ROOT}/demisto_sdk/tests/test_files/IncidentType__raw_downdloaded.json"
CONTENT_VALID_INCIDENT_TYPE_FILE = f"{GIT_ROOT}/demisto_sdk/tests/test_files/IncidentType.json"
