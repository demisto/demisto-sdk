...
SOURCE_FORMAT_INTEGRATION1 = f"demisto_sdk/tests/test_files/integration-fetch-valid.yml"
SOURCE_FORMAT_INTEGRATION2 = f"demisto_sdk/tests/test_files/integration-fetch-invalid.yml"
