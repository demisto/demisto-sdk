...
SOURCE_FORMAT_INCIDENTFIELD_COPY = f"{GIT_ROOT}/demisto_sdk/tests/test_files/format_incidentfield_copy.json"
DESTINATION_FORMAT_INCIDENTFIELD_COPY = f"new_format_incidentfield_copy.json"
SOURCE_FORMAT_INCIDENTTYPE_COPY = f"{GIT_ROOT}/demisto_sdk/tests/test_files/format_incidenttype_copy.json"
DESTINATION_FORMAT_INCIDENTTYPE_COPY = f"new_format_incidenttype_copy.json"
SOURCE_FORMAT_INDICATORFIELD_COPY = f"{GIT_ROOT}/demisto_sdk/tests/test_files/format_indicatorfield_copy.json"
DESTINATION_FORMAT_INDICATORFIELD_COPY = f"new_format_indicatorfield_copy.json"
SOURCE_FORMAT_INDICATORTYPE_COPY = f"{GIT_ROOT}/demisto_sdk/tests/test_files/format_indicatortype_copy.json"
DESTINATION_FORMAT_INDICATORTYPE_COPY = f"new_format_indicatortype_copy.json"
SOURCE_FORMAT_LAYOUT_COPY = f"{GIT_ROOT}/demisto_sdk/tests/test_files/format_layout_copy.json"
DESTINATION_FORMAT_LAYOUT_COPY = f"new_format_layout_copy.json"
SOURCE_FORMAT_DASHBOARD_COPY = f"{GIT_ROOT}/demisto_sdk/tests/test_files/format_dashboard_copy.json"
DESTINATION_FORMAT_DASHBOARD_COPY = f"new_format_dashboard_copy.json"
