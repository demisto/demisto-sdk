...
INVALID_LAYOUT_PATH2 = f"{GIT_ROOT}/demisto_sdk/tests/test_files/layout-invalid2.json"
INVALID_LAYOUT_PATH3 = f"{GIT_ROOT}/demisto_sdk/tests/test_files/layout-invalid3.json"
