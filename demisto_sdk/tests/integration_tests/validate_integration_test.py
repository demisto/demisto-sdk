...
class TestPackValidation:
    def test_integration_validate_pack_positive(self, mocker):
        ...
        mocker.patch.object(IntegrationValidator, 'validate_readme_exists', return_value=True)
...
class TestPlaybookValidation:
    def test_valid_playbook(self, mocker):
        ...
        mocker.patch.object(PlaybookValidator, 'validate_readme_exists', return_value=True)
        runner = CliRunner(mix_stderr=False)
