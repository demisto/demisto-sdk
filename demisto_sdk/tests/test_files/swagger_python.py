...
class Client(BaseClient):
    ...
    def add_pet_request(
        self, pet_id, pet_category, pet_name, pet_photourls, pet_tags, pet_status
    ):
        data = assign_params(
            id=pet_id,
    ...
    def create_users_with_array_input_request(
        self,
        user_id,
        user_username,
        user_firstname,
    ...
    def create_users_with_list_input_request(
        self,
        user_id,
        user_username,
        user_firstname,
    ...
    def post_pet_upload_image_request(
        self, petId, filter_, arg_name, additionalMetadata, file
    ):
    ...
    def post_pet_upload_image_by_uploadimage_request(
        self, petId, additionalMetadata, file
    ):
        data = assign_params(additionalMetadata=additionalMetadata, file=file)
        headers = self._headers
        headers["Content-Type"] = "multipart/form-data"
        ...
        response = self._http_request(
            "post",
            f"pet/{petId}/uploadImage/{uploadimage}",
            json_data=data,
            headers=headers,
        )
...
def create_users_with_array_input_command(
...
def create_users_with_list_input_command(
    client: Client, args: Dict[str, Any]
) -> CommandResults:
    user_id = args.get("user_id", None)
    user_username = str(args.get("user_username", ""))
...
def post_pet_upload_image_command(
    client: Client, args: Dict[str, Any]
) -> CommandResults:
    petId = args.get("petId", None)
...
def post_pet_upload_image_by_uploadimage_command(
    client: Client, args: Dict[str, Any]
) -> CommandResults:
    petId = args.get("petId", None)
    additionalMetadata = str(args.get("additionalMetadata", ""))
...
def update_pet_with_form_command(
    client: Client, args: Dict[str, Any]
) -> CommandResults:
    petId = args.get("petId", None)
...
def update_user_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.update_user_request(
        username,
        user_id,
        user_username,
        user_firstname,
