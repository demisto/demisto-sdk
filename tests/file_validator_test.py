...
class FileValidatorTest:
    ...
    def test_get_modified_files(self):
        ...
        modified_files, added_files, _, _ = self.validator.get_modified_files(changed_files)
        assert 'Integrations/integration-Recorded_Future.yml' in modified_files
        assert 'Integrations/Recorded_Future/Recorded_Future.yml' in added_files
