...
INDICATORFIELD_EXTRA_FIELDS = './tests/test_files/indicatorfield-extra-fields.json'
INDICATORFIELD_EXACT_SCHEME = './tests/test_files/indicator-field-exact-scheme.json'
INDICATORFIELD_MISSING_FIELD = './tests/test_files/indicator-field-missing-field.json'
INDICATORFIELD_MISSING_AND_EXTRA_FIELDS = './tests/test_files/indicatorfield-missing-and-extra-fields.json'
